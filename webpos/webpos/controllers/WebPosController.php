 ...
 */
class WebPosController extends Yf_AppController
{
	...
	public function getUrl($ctl, $met, $typ = 'json')
	{
		...
		fb($formvars);
		$init_rs = get_url_with_encrypt($key, sprintf('%s?ctl=WebPosApi_%s&met=%s&typ=json', $url, $ctl, $met), $formvars);
