...
<head>
	...
	<link href="<?= $this->view->css ?>/iconfont.css" rel="stylesheet" type="text/css">
	...
	<script src="<?= $this->view->js_com ?>/plugins/jquery.dialog.js?self=true&ver=20140430"></script>
	...
	<script type="text/javascript">
        ...
        var PAY_URL =  "<?=Yf_Registry::get('paycenter_api_url')?>";
		var SHOP_ID =   "<?=Perm::$shopId?>";
		...
		SYSTEM.salesName = "<?=Perm::$row['user_account']?>";
