...
seajs.config({
    ...
    alias: {
        jquery: "libs/jquery/jquery-1.10.2.min.js",
        plugins: "libs/jquery/plugins.js",
        grid: "libs/jquery/grid.js",
        dialog: "libs/jquery/plugins/jquery.dialog.js?self=true",
        datepicker: "libs/jquery/plugins/datepicker/pikaday.js",
        print: "libs/jquery/jquery.print.js",
        main: "libs/jquery/main.js"
    },
    preload: [
        this.JSON ? '' : 'libs/jquery/json2.js',
        "plugins",
        "grid",
        "dialog",
        "main"
