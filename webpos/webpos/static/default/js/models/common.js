...
Public.operFmatter = function (val, opt, row) {
    var html_con = '<div class="operating" data-id="' + row.id + '"><span class="ui-icon ui-icon-pencil" title="修改"></div>';
    return html_con;
};
    ...
    if(type !== 'assemble') {
        $('#customer').on('click', '.ui-icon-ellipsis', function(e){
            ...
            if(lable === '供应商' || lable === '购货单位') {
                ...
                var content = 'url:'+SITE_URL+'?ctl=User&met=buyerList';
            }
        ...
        $('.grid-wrap').on('click', '.goods .ui-icon-ellipsis', function(e){
            ...
            $.dialog({
                ...
                height: 510,
                title: '选择商品',
                content: 'url:'+SITE_URL+'?ctl=Goods&met=goodsList&typ=e',
                data: {
                    skuMult: skuMult,
                    skey:_self.skey,
...
Business.filterCustomer = function(){
    ...
    $('#filter-customer .ui-icon-ellipsis').on('click', function(){
        ...
        $.dialog({
            ...
            height: 500,
            title: '选择客户',
            content: 'url:'+SITE_URL+'?ctl=User&met=buyerList',
            data:{isDelete:2},
            lock: true,
            ok: function(){
...
Public.print = function (opt){
    ...
    $.dialog({
        title: opt.title,
        content : 'url:'+SITE_URL+'?ctl=Order&met=printOrder&id='+originalData.id,
