        ...
        return {
            init: function( selectCb ) {
                uploader = new Uploader({
                    ...
                    server: SHOP_URL + "?ctl=Upload&action=" + uploadConfig.imageActionName + '&user=admin',
                ...
                uploader.on('uploadSuccess', function (file, response) {
                    ...
                    if ( typeof _data.callback === 'function' ) {
                        response.url += '!' + _data.width + 'x' + _data.height + '.jpg';
...
// ------------------------------
    ...
    if (typeof(uploadConfig) === 'undefined'){
        ...
        $.ajax({
            type: "get",
            url: SHOP_URL + "?ctl=Upload&action=config",
            dataType: "jsonp",
            jsonp: "callback",
