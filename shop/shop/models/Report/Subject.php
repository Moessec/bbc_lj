 ...
 * @todo
 */
class Report_Subject extends Yf_Model
{
	public $_cacheKeyPrefix  = 'c|report_subject|';
	public $_cacheName       = 'report';
	public $_tableName       = 'report_subject';
	public $_tablePrimaryKey = 'report_subject_id';
