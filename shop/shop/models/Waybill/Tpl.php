 ...
 * @todo
 */
class Waybill_Tpl extends Yf_Model
{
	public $_cacheKeyPrefix  = 'c|waybill_tpl|';
	public $_cacheName       = 'tpl';
	public $_tableName       = 'waybill_tpl';
	public $_tablePrimaryKey = 'waybill_tpl_id';
	 ...
	 * @access public
	 */
	public function getTpl($waybill_tpl_id = null, $sort_key_row = null)
	{
		$rows = array();
		$rows = $this->get($waybill_tpl_id, $sort_key_row);
	 ...
	 * @access public
	 */
	public function editTpl($waybill_tpl_id = null, $field_row)
	{
