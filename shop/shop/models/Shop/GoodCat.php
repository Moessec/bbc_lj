 ...
 * @todo
 */
class Shop_GoodCat extends Yf_Model
{
	 ...
	 * @access public
	 */
	public function getGoodCat($config_key = null, $sort_key_row = null)
	{
		$rows = array();
	 ...
	 * @access public
	 */
	public function addGoodCat($field_row, $return_insert_id = false)
	{
	 ...
	 * @access public
	 */
	public function editGoodCat($config_key = null, $field_row)
	{
	 ...
	 * @access public
	 */
	public function editGoodCatSingleField($config_key, $field_name, $field_value_new, $field_value_old)
	{
	 ...
	 * @access public
	 */
	public function removeGoodCat($config_key)
	{
