 ...
 * @todo
 */
class Shop_Base extends Yf_Model
{
	 ...
	 * @access public
	 */
	public function getBase($config_key = null, $sort_key_row = null)
	{
		$rows = array();
	 ...
	 * @access public
	 */
	public function editBase($config_key = null, $field_row)
	{
	...
	public function editBaseCollectNum($config_key = null, $field_row, $flag = false)
	{
	 ...
	 * @access public
	 */
	public function editBaseSingleField($config_key, $field_name, $field_value_new, $field_value_old)
	{
	 ...
	 * @access public
	 */
	public function getshopName($config_key = null)
	{
		$data      = $this->getOne($config_key);
	 ...
	 * @access public
	 */
	public function getuserName($config_key = null)
	{
		$data      = $this->getOne($config_key);
