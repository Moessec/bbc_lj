        ...
        <div class="order_content">
          <div class="div_head tabmenu clearfix">
            <ul class="tab clearfix">
              <li><a href="<?= Yf_Registry::get('url') ?>?ctl=Buyer_Points&met=points"><?=_('积分明细')?></a></li>
              <li  class="active"> <a href="<?= Yf_Registry::get('url') ?>?ctl=Buyer_Points&met=points&op=getPointsOrder"><?=_('兑换记录')?></a></li>
            </ul>
          </div>
          <ul>
            <li> 
			...
			<script type="text/javascript">
				...
				<thead>
                  <tr class="bortop">
					  ...
					  <th> <?=_('合计（积分）')?> </th>
					  <th> <?=_('交易状态')?> </th>
					  <th style="width:200px"> <?=_('交易操作')?> </th>
                  </tr>
				 </thead>
