...
<div class="invoice-thickbox" id="invoice-tab">
  ...
  <div class="tab-nav">
    <ul>
      <li id="click_1" class="tab-nav-item" value="1" clstag="pageclick|keycount|trade_201602181|17"><p>普通发票</p><b></b></li>
      <li id="click_2" class="tab-nav-item tab-item-selected" value="2" clstag="pageclick|keycount|trade_201602181|19"><p>电子发票</p><b></b></li>
      <li id="click_3" class="tab-nav-item" value="3" clstag="pageclick|keycount|trade_201602181|18"><p>增值税发票</p><b></b></li>
    </ul>
  </div>
   <!-- 普通发票 -->

  <div id="noraml" class="tab-con form" style="display:none"  >
    <div class="item"> <span class="label"><?=_('发票抬头：')?></span>
      <div class="fl">
        <div class="invoice-list invoice-tit-list" id="invoice-tit-list">
          <div class="invoice-item invoice-item-selected" style="cursor:pointer" onclick="selected(this)" >
            <div id="invoice-1" style="cursor:pointer"> <span class="hide">
              ...
              <input type="text" style="cursor:pointer" class="itxt" data-r="<?=_('个人')?>" value="<?=_('个人')?>" readonly>
              <b></b></span> </div>
          </div>
          ...
          <div class="invoice-item" style="cursor:pointer" onclick="selected(this)" onmouseover="show_op(this)" onmouseout="hide_op(this)">
            <div id="invoice-2" style="cursor:pointer"> <span class="hide">
                  ...
                  <a  class="ftx-05 save-tit hide" onclick="save_invoice(this)"><?=_('保存')?></a>
                  <a  class="ftx-05 edit-tit hide show" onclick="edit_invoice(this)"><?=_('编辑')?></a>
                  <a  class="ftx-05 del-tit hide" onclick="del_invoice(this)"><?=_('删除')?></a>
                  <b></b></span>
            </div>
          </div>
          <?php }}?>
        </div>
        <div id="add-invoice" class="add-invoice"><a href="#" class="ftx-05 add-invoice-btn" onclick="add_save()">新增单位发票</a></div>
      </div>
    </div>
  ...
  <div class="tab-box" >
    <div class="tab-con" id="fapiao" style="display:none">
      <div class="form">
        <div class="item"> <span class="label"><?=_('发票内容：')?></span>
          <div class="fl">
            <div class="invoice-list">
              <ul id="electro_book_content_radio" class="content_radio">
                <li class="invoice-item invoice-item-selected" id="electro-invoice-content-1" name="normal-normalContent" value="<?=_('明细')?>" style="cursor:pointer"> <p><?=_('明细')?></p><b></b> </li>
                <li class="invoice-item" id="electro-invoice-content-22" name="normal-normalContent" value="<?=_('办公用品')?>" style="cursor:pointer"> <p><?=_('办公用品')?></p><b></b> </li>
                <li class="invoice-item" id="electro-invoice-content-3" name="normal-normalContent" value="<?=_('电脑配件')?>" style="cursor:pointer"> <p><?=_('电脑配件')?></p><b></b> </li>
                <li class="invoice-item" id="electro-invoice-content-19" name="normal-normalContent" value="<?=_('耗材')?>" style="cursor:pointer"> <p><?=_('耗材')?></p><b></b> </li>
              </ul>
            </div>
          </div>
        </div>
        ...
        <div id="giftInvoicePart" class="hide">
          <div class="item"> <span class="label"><?=_('配送方式：')?></span>
            <div class="fl">
              <div class="invoice-list">
                <ul>
                  <li class="invoice-item   invoice-item-selected " onclick="changeGiftType(0)" style="cursor:pointer"><?=_('随礼品寄送')?><b></b></li>
                  <li class="invoice-item  " onclick="changeGiftType(3)" style="cursor:pointer"><?=_('单独寄送')?><b></b></li>
                </ul>
              </div>
            </div>
          </div>
          ...
          <div id="sendSeparateView" style="display:none">
            <div class="item" id="generalInvoice_name_div"> <span class="label"><em><?=_('*')?></em><?=_('收票人姓名：')?></span>
              <div class="fl">
            ...
            <div class="item" id="generalInvoice_call_div"> <span class="label"><em><?=_('*')?></em><?=_('收票人手机：')?></span>
              <div class="fl">
            ...
            <div class="item" id="generalInvoice_area_div"> <span class="label"><em><?=_('*')?></em><?=_('收票人省份：')?></span>
              <div class="fl" id="generalInvoice_span_area"></div>
              <span id="generalInvoice_area_div_error"></span> </div>
            <div class="item" id="generalInvoice_address_div"> <span class="label"><em><?=_('*')?></em><?=_('详细地址：')?></span>
              <div class="fl">
        ...
        <div class="item"> <span class="label">&nbsp;</span>
          <div class="fl" >
            <div class="op-btns"> <a  class="btn-9" onclick="save_Invoice(this)"><?=_('保存发票信息')?></a> <a href="#none" class="btn-9 ml10" onclick="quxiao()"><?=_('取消')?></a> </div>
            <div class="ftx-03 mt10"> <?=_('温馨提示：发票的开票金额不包括代金券、积分支付部分')?><br>
    ...
    <div id="Electronics" class="tab-con ui-switchable-panel-selected" >
      ...
      <div class="prompt-box"><?=_('电子发票是税局认可的有效凭证，其法律效力、基本用途及使用规定同纸质发票，如需纸质票可自行下载打印。如您本次购买的商品暂未实现电子发票开具，我们将自动更换为普通发票（纸质）同商品一并送达，请您注意查收。')?><br>
      ...
      <div class="form">
            ...
            <div class="invoice-list invoice-tit-list" id="invoice-tit-list">
              <div class="invoice-item invoice-item-selected" style="cursor:pointer" onclick="selected(this)">
                <div id="invoice-2" style="cursor:pointer"> <span class="hide">
                  ...
                  <input type="text" style="cursor:pointer" class="itxt"  value="<?=_('个人')?>" readonly>
                  <b></b></span> </div>
              </div>
              <div class="invoice-item" onclick="selected(this)" style="cursor:pointer">
                <div id="invoice-2" style="cursor:pointer"> <span class="hide">
                  ...
                  <input type="text" class="itxt itxt04" placeholder="<?=_('请填写公司发票抬头')?>" value="<?php if(isset($data['electron'])){ echo $data['electron'][0]['invoice_title']; }?>">
                  <b></b></span> </div>
              </div>
            </div>
          </div>
          ...
          <div class="fl">
            <div class="invoice-list">
              <ul id="electro_book_content_radio_T" class="content_radio">
                <li class="invoice-item invoice-item-selected" id="electro-invoice-content-2" name="electro-normalContent" value="<?=_('明细')?>" style="cursor:pointer"> <p><?=_('明细')?></p><b></b> </li>
                <li class="invoice-item" id="electro-invoice-content-4" name="electro-normalContent" value="<?=_('办公用品')?>" style="cursor:pointer"> <p><?=_('办公用品')?></p><b></b> </li>
                <li class="invoice-item" id="electro-invoice-content-6" name="electro-normalContent" value="<?=_('电脑配件')?>" style="cursor:pointer"> <p><?=_('电脑配件')?></p><b></b> </li>
                <li class="invoice-item" id="electro-invoice-content-5" name="electro-normalContent" value="<?=_('耗材')?>" style="cursor:pointer"> <p><?=_('耗材')?></p><b></b> </li>
              </ul>
            </div>
          </div>
        </div>
        ...
        <div class="item"> <span class="label"><em><?=_('*')?></em><?=_('收票人手机：')?></span>
          <div class="fl">
        ...
        <div class="item"> <span class="label"><?=_('收票人邮箱：')?></span>
          <div class="fl">
        ...
        <div class="item"> <span class="label">&nbsp;</span>
          <div class="fl">
            <div class="op-btns"> <a class="btn-9" onclick="save_Invoice(this)"><?=_('保存发票信息')?></a> <a class="btn-9 ml10" onclick="quxiao()"><?=_('取消')?></a> </div>
            <div class="ftx-03 mt10"> <?=_('温馨提示：发票的开票金额不包括代金券、积分支付部分')?><br>
    ...
    <div id="increment" class="tab-con"   style="display:none">
      <form id="iform">
      <div class="prompt-box"> <?=_('我公司依法开具发票，如您购买的商品按税法规定属于不得从增值税销项税额中抵扣的项目（例如集体福利或个人消费等），请您选择普通发票。')?><br>
      ...
      <div class="form" id="invoice-box-03">
        <ul class="invoice-status">
          <li class="fore1 curr"><?=_('1.填写公司信息')?><b></b></li>
          <li class="fore2 "><?=_('2.填写收票人信息')?><b></b></li>
        </ul>
        <div class="steps">
          <div class="step step1">
            <input type="hidden" id="vatCanEdit" value="false">
            <div class="item"> <span class="label" id="vat_companyName_div"><em><?=_('*')?></em><?=_('单位名称：')?></span>
              <div class="fl">
            ...
            <div class="item" id="vat_code_div"> <span class="label"><em><?=_('*')?></em><?=_('纳税人识别码：')?></span>
              <div class="fl">
            ...
            <div class="item" id="vat_address_div"> <span class="label"><em><?=_('*')?></em><?=_('注册地址：')?></span>
              <div class="fl">
            ...
            <div class="item" id="vat_phone_div"> <span class="label"><em><?=_('*')?></em><?=_('注册电话：')?></span>
              <div class="fl">
            ...
            <div class="item" id="vat_bankName_div"> <span class="label"><em><?=_('*')?></em><?=_('开户银行：')?></span>
              <div class="fl">
            ...
            <div class="item" id="vat_bankAccount_div"> <span class="label"><em><?=_('*')?></em><?=_('银行账户：')?></span>
              <div class="fl">
            ...
            <div class="item"> <span class="label">&nbsp;</span>
              <div class="fl">
                <div class="op-btns">
                  <input id="vat-btn-save" type="button" class="btn-9" onclick="nextAvt()" value="<?=_('下一步')?>">
                  <input id="vat-btn-cancel" type="button" class="btn-9" onclick="quxiao()" value="<?=_('取消')?>">
                </div>
                <div class="ftx-03 mt10"> <?=_('温馨提示：发票的开票金额不包括代金券、积分支付部分')?><br>
          ...
          <div class="step step2 hide">
            ...
            <div class="item" id="name_div"> <span class="label"><em><?=_('*')?></em><?=_('收票人姓名：')?></span>
              <div class="fl">
            ...
            <div class="item" id="call_div"> <span class="label"><em><?=_('*')?></em><?=_('收票人手机：')?></span>
              <div class="fl">
            ...
            <div class="item vat-step-2" id="area_div"> <span class="label"><em><?=_('*')?></em><?=_('收票人省份：')?></span>
            ...
            <div class="item" id="address_div"> <span class="label"><em><?=('*')?></em><?=('详细地址：')?></span>
              <div class="fl">
            ...
            <div class="item"> <span class="label">&nbsp;</span>
              <div class="fl">
                <div class="op-btns"> <a class="btn-9" onclick="save_Invoice(this)"><?=('保存')?></a> <a class="btn-9 ml10" onclick="quxiao()"><?=('取消')?></a> <a href="#none" class="ftx-05 ml10 prev" onclick="prev()"><?=('返回上一步')?></a> </div>
                <div class="ftx-03 mt10"> <?=('温馨提示：发票的开票金额不包括代金券、积分支付部分')?><br>
                  <!--<a href="http://help.jd.com/user/issue/list-182.html" target="_blank" class="ftx-05">发票信息相关问题&gt;&gt;</a>--> </div>
              </div>
            </div>
          </div>
