			...
			<ul class="ncm-friend-list">
				...
				<li id="recordone_76">
				  ...
				  <div class="follow">
					...
					<a class="ncbtn-mini ncbtn-mint  bbc_btns"  data-param="{'ctl':'Buyer_User','met':'addFriendDetail','id':'<?=$v['detail']['user_id']?>'}" <?php if($v['detail']['status']==1){?>style="display:none;"<?php }else{?>style="display:block;"<?php }?> href="javascript:void(0)"><?=_('加关注')?></a>
