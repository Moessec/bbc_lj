                   ...
                   <!-- <dl>
                      ...
                      <dd><span class="w400">
                        ...
                        <select name="privacy[user_privacy_ww]">
                          <option value="0" <?php if($privacy ['user_privacy_ww'] == 0){?>selected="selected"<?php }?>><?=_('公开')?></option>
                          <option value="1" <?php if($privacy ['user_privacy_ww'] == 1){?>selected="selected"<?php }?>><?=_('好友可见')?></option>
                          <option value="2" <?php if($privacy ['user_privacy_ww'] == 2){?>selected="selected"<?php }?>><?=_('保密')?></option>
                        </select>
                        </span></dd>
                    </dl>-->
                    <dl class="bottom">
