...
$(".submit").click(function(){
    ...
    <?php }else{?>
        <div class="security-tips">修改密码前必须先进行邮箱绑定或手机绑定，点击这里进行<a href="<?= Yf_Registry::get('url') ?>?ctl=Buyer_User&met=security&op=mobile">手机绑定</a>或<a href="<?= Yf_Registry::get('ucenter_api_url') ?>?ctl=User&met=security&op=email">邮箱绑定</a></div>
    <?php }?>
</div>
<?php
