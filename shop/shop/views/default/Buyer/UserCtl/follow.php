...
?>
      ...
      <div class="member_infor_content">
        <div class="tabmenu">
          <ul class="tab pngFix">
           <li><a href="<?= Yf_Registry::get('url') ?>?ctl=Buyer_User&met=friend"><?=_('查找好友')?></a></li>
			<li class="active"><a href="<?= Yf_Registry::get('url') ?>?ctl=Buyer_User&met=friend&op=follow"><?=_('我关注的')?></a></li>
			...
			<ul class="ncm-friend-list">
				...
				<li id="recordone_76">
				  ...
				  <dl class="info">
					...
					<dd></dd>
					<dd><a href="<?= Yf_Registry::get('url') ?>?ctl=Buyer_Message&met=message&op=sendMessage&id=<?=$v['detail']['user_id']?>" title="<?=_('站内信')?>"><i class="icon-envelope"></i><?=_('站内信')?></a> </dd>
				  </dl>
				  <div class="follow">
				  <?php if($v['detail']['status']==1){?>
					...
					<a href="javascript:void(0)" class="ncbtn-mini-blank  bbc_btns" data-param="{'ctl':'Buyer_User','met':'cancelFriendDetail','id':'<?=$v['user_friend_id']?>'}"><?=_('取消关注')?></a>
					</div>
				</li>
				<?php }?>
				<?php }?>
