            ...
            <div class="ncm-flow-layout" id="ncmComplainFlow">
                    ...
                    <div class="ncm-default-form">
                        ...
                        <dl>
                            ...
                            <dd>
                                ...
                                { ?>
                                    <?= _('暂无图片 ') ?><label class="submit-border bbc_btns"><input id="btn_buchong" type="button"
                                ...
                                { ?>
                                    <dd>
                                        <label id="handle_submit" class="submit-border">
                                            <input type="button" value="<?= _('提交冲裁') ?>" class="submit">
                                        </label>
                                        <label id="handle_close" class="submit-border">
                                            <input type="button" value="<?= _('关闭投诉') ?>" class="submit">
                                        </label>
                                    </dd>
                                <?php } ?>
                            </form>
                ...
                <div class="ncm-flow-item">
                    ...
                    <div class="item-goods">
                        <dl>
                            <dd><a target="_blank"
                                   href="<?= Yf_Registry::get('url') ?>?ctl=Goods_Goods&met=goods&gid=<?= $data['ordergoods']['goods_id'] ?>"><?= $data['ordergoods']['goods_name'] ?></a>
                                <?= $data['ordergoods']['goods_price'] ?>
                                * <?= $data['ordergoods']['order_goods_num'] ?>
                                <font color="#AAA">(<?= _('数量') ?>)</font>
                                <span></span>
                            </dd>
                        </dl>
                    </div>
                    <div class="item-order">
                            ...
                            <dd>
                                <a href="<?= Yf_Registry::get('url') ?>?ctl=Buyer_Order&met=physical&act=details&order_id=<?= $data['order']['order_id'] ?>"
                                   target="_blank"> <?= $data['order']['order_id'] ?> </a> <a
                                    href="javascript:void(0);" class="a"><?= _('更多') ?><i
                                        class="iconfont icon-jiantouxiangxia"></i>
                                    <div class="more"><span class="arrow"></span>
                                        <ul>
                                            <li><?= _('支付方式：') ?><span><?= $data['order']['payment_name'] ?></span></li>
                                            <li><?= _('下单时间：') ?><span><?= $data['order']['order_create_time'] ?></span>
                                            </li>
                                            <li><?= _('付款时间：') ?><span><?= $data['order']['payment_time'] ?></span></li>
                                            <li><?= _('发货时间：') ?>
                                                <span><?= $data['order']['order_shipping_time'] ?></span></li>
                                            <li><?= _('完成时间：') ?>
                                                <span><?= $data['order']['order_finished_time'] ?></span></li>
                                        </ul>
                                    </div>
                                </a></dd>
                        </dl>
                        <dl class="line">
                            ...
                            <dd><?= $data['order']['shop_name'] ?><a
                                    ...
                                    <div class="more"><span class="arrow"></span>
                                        <ul>
                                            <li><?= _('所在地区：') ?><span><?= $data['shop']['shop_address'] ?></span></li>
                                            <li><?= _('联系电话：') ?><span><?= $data['shop']['shop_tel'] ?></span></li>
                                        </ul>
                                    </div>
                                </a>
                            </dd>
