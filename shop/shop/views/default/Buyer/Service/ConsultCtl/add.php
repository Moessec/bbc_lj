    ...
    <div id="warning" class="alert alert-error"></div>
            <form id="form" action="#" method="post">
                ...
                <dl>
                    <dt><?=_('商城承诺：')?></dt>
                    <dd>
                        <?=_('商品均为原装正品行货，自带机打发票，严格执行国家三包政策，享受全国联保服务。')?>
                    </dd>
                </dl>
                <dl>
                    <dt><?=_('功能咨询：')?></dt>
                    <dd>
                        <?=_('咨询商品功能建议您拨打各品牌的官方客服电话，以便获得更准确的信息。')?>
                    </dd>
                </dl>
                <dl>
                    <dt><?=_('用户名：')?></dt>
                    <dd>
                        <?=Perm::$row['user_account']?> <input type="checkbox" name="no_show_user" value="1"> <?=_('匿名提问')?>
                    </dd>
                </dl>
                <dl>
                    <dt><?=_('咨询问题：')?></dt>
                ...
                <div class="bottom">
                    <label class="submit-border"><input id="handle_submit" class="submit bbc_btns" value="<?=_('提问')?>"/></label>
                </div>
            </form>
</div>
