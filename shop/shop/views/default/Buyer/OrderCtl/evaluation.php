          ...
          <form id="goodsevalform" method="get" class="tc">
            ...
            <div class="evaluation-timeline clearfix">
                ...
                <dl class="detail detail_dls">
                  <dt class="clearfix">
                        <span><?=_('评论时间：')?><?=($value[0]['create_time'])?></span>
                ...
                <?php if($value[0]['explain_content']): ?>
                    ...
                    <dl class="detail_dls detail_explain_color">
                        <dd><strong><?=_('商家解释')?></strong></dd>

                        <dd>
                             <span><?=_('解释时间：')?><?=($value[0]['update_time'])?></span>
                        </dd>
                ...
                <?php if(!isset($value[1])):?>
                  <span>
                    <a class="btnredpj bbc_seller_btns" href="<?= Yf_Registry::get('url') ?>?ctl=Buyer_Order&met=evaluation&act=again&oge_id=<?=($value[0]['evaluation_goods_id'])?>"  id="explain"><i class=" bbc_seller_btns iconfont icon-shangjiaruzhushenqing"></i><?=_('追加评价')?></a>
                  </span>
                <?php endif;?>
                ...
                <?php if(isset($value[1])):?>
                    ...
                    <dl class="detail detail_dls">
                      <dt class="clearfix">
                            <span><?=_('追加时间：')?><?=($value[1]['create_time'])?></span>
                      </dt>
                      ...
                      <div class="evaluate_img">
                        ...
                        <?php if($value[1]['explain_content']): ?>
                            ...
                            <dl class="detail_dls detail_explain_color">
                                ...
                                <dd class="clearfix">
                                    <span><?=_('解释时间：')?><?=($value[1]['update_time'])?></span>
                                </dd>
