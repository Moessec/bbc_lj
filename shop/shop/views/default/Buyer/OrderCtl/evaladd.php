...
<form action="" enctype="multipart/form-data" id="form" name="form" method="post">
        ...
        <div class="logistics_mes clearfix">
            <div class="logistics_mes_left">
                ...
                <div class="distribution_personnel">
                    ...
                    <p class="dis_personal_mes"><?=_('电话：')?><?=($data['shop_base']['shop_tel'])?></p>
                </div>
            </div>
            ...
            <div class="evaluation-timeline view_mes clearfix">
                ...
                <dl class="detail detail_dls">
                    <dt class="clearfix  detail_first">
                        ...
                        <!-- 商品名称 -->
                        <span><a href="<?= Yf_Registry::get('url') ?>?ctl=Goods_Goods&met=goods&gid=<?=($ogval['goods_id'])?>"><?=($ogval['goods_name'])?></a></span>
                        <!-- 商品价格 -->
                    ...
                    <div class="pingfen clearfix">
                        ...
                        <p>
                            <span id="stextd<?=($i)?>" class="stextd<?=($i)?>"><b><?=_('5分')?></b></span>
                        </p>
                    ...
                    <div class="feeling clearfix">
                        <p class="inp_warn">
                            <textarea name="content" class="content" placeholder="<?=_('商品是否给力？快分享你的购物心得吧')?>"></textarea>
                            <!--<span class="inp_warn_text"><h6><span>200</span>个字，现在剩余<span id="word">200</span>个</h6></span>-->
                            <span class="inp_warn_text" style="width: 300px;"><?=_('说点什么吧，你可以输入1-200个字，现在剩余')?><strong id="word"><?=_('200')?></strong><?=_('个字')?></span>
                        </p>
                    </div>
                    <div class="clearfix show_goods_mar">
                        ...
                        <a id="filePicker" class="js-file-picker add_img add_box filePicker" style="height: 43px;height: 57px;border: none;"><i class="iconfont icon-jia"></i><?=_('晒单')?></a>
    ...
    <!--E 循环评价商品 -->
        ...
        <div class="publish_eval">
            <p>
                <a  class="up_view submit bbc_btns"><?=_('发布评价')?></a>
                <input name="isanonymous" class="isanonymous" type="checkbox" value="1"><span><?=_('匿名评价')?></span>
            </p>
        </div>
    </div>
</form>
