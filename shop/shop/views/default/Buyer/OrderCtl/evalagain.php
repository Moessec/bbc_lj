		...
		<div class="order_content">
            <div class="evaluation-timeline logistics_mes clearfix" style="margin-bottom: 50px;">
                ...
                <div class="date clearfix">
                    ...
                    <div class="goods_image">
                        <a target="_blank" href="<?= Yf_Registry::get('url') ?>?ctl=Goods_Goods&met=goods&gid=<?=($data['goods_base']['goods_id'])?>">
                    ...
                    <div class="order_goods">
                        <!-- 商品名称 -->
                        <a href="<?= Yf_Registry::get('url') ?>?ctl=Goods_Goods&met=goods&gid=<?=($data['goods_base']['goods_id'])?>"><?=($data['goods_base']['goods_name'])?></a>
                        <!-- 商品价格 -->
              ...
              <div class="view_mes clearfix">
                  ...
                  <dl class="detail detail_dls">
                      <dt class="clearfix">
                            <span><?=_('评论时间：')?><?=($data['create_time'])?></span>
            ...
            <div class="order_myview">
              ...
              <div class="view_mes clearfix">
                ...
                <div class="detail detail_dls">
                    <div class="feeling clearfix">
						<p class="inp_warn">
							<textarea name="content" id="content" placeholder="<?=_('商品是否给力？快分享你的购物心得吧')?>"></textarea>
                    ...
                    <div class="clearfix show_goods_mar">
						...
						<a id="filePicker" class="js-file-picker add_img add_box" style="height: 43px;height: 57px;border: none;"><i class="iconfont icon-jia"></i><?=_('晒单')?></a>
					</div>
                  </div>
                <!-- E 追加评论内容 -->
              ...
              <div class="publish_eval">
                    <p>
                        <a  class="up_view submit bbc_btns"><?=_('追加评价')?></a>
                        <!--<input name="isanonymous" type="checkbox" value="1"><span><?/*=_('匿名评价')*/?></span>-->
                    </p>
                </div>
            </div>
            <!--E  追加评价内容-->
