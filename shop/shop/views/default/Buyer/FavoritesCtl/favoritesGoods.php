              ...
              <ul>
                ...
                <li class="favorite-pic-list">
                  <div class="favorite-goods-thumb">
                    <a href="<?= Yf_Registry::get('url') ?>?ctl=Goods_Goods&met=goods&gid=<?=$val['detail']['goods_id']?>" target="_blank" title="<?=$val['detail']['goods_name']?>">
                  ...
                  <div class="handle">
                    <a href="javascript:void(0)" data-param="{'ctl':'Buyer_Favorites','met':'delFavoritesGoods','id':'<?=$val['goods_id']?>'}" class="fr ml5 delete" title="<?=_('删除')?>"><i class="iconfont icon-lajitong"></i>
                    </a>
                    <a href="javascript:void(0)" class="fr add_cart" title="<?=_('加入购物车')?>" data-param="{'ctl':'Buyer_Cart','met':'addCart','id':'<?=$val['goods_id']?>','num':'1'}"> <i class="iconfont icon-zaiqigoumai"></i>
                    </a>
                    
                  </div>
                  <dl class="favorite-goods-info">
                    <dt>
                      <a href="<?= Yf_Registry::get('url') ?>?ctl=Goods_Goods&met=goods&gid=<?=$val['detail']['goods_id']?>" target="_blank" title="<?=$val['detail']['goods_name']?>"><?=$val['detail']['goods_name']?></a>
                    </dt>
                    <dd class="goods-price">
                      <strong><?=format_money($val['detail']['goods_price'])?></strong>
                    </dd>
                  </dl>
                </li>
				<?php }?>
