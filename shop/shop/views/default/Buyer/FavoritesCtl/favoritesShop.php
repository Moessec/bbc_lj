         ...
         <!--  有内容显示 -->
          ...
          <div class="ncm-favorite-store">
           ...
           <div class="store-goods" >
             <a href="<?= Yf_Registry::get('url') ?>?ctl=Shop&met=index&typ=e&id=<?=$val['shop']['shop_id']?>" class="more" target="_blank"><?=_('查看更多')?><i class="iconfont icon-iconjiantouyou"></i></a>
				...
				<?php foreach($val['shop']['detail']['items'] as $v){ ?>
                 <li>
                   <div class="goods-thumb">
                     <a href="<?= Yf_Registry::get('url') ?>?ctl=Goods_Goods&met=goods&gid=<?=$v['goods_id']?>" title="<?=$v['common_name']?>" target="_blank">
