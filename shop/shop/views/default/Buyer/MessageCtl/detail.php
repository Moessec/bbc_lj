...
<div class="aright">
	<div class="member_infor_content">
      <div class="tabmenu">
		<ul class="tab">
			...
			<li class="active"><a href="<?= Yf_Registry::get('url') ?>?ctl=Buyer_Message&met=message&op=detail"><?=_('查看站内信')?></a></li>
        </ul>
    </div>
   <div class="form-style">
    <form id="form" name="form" action="" method="post">
        ...
        <dl>
            <dt><?=$val['user_message_send']?><?=_('说：')?></dt>
            <dd><?=$val['user_message_content']?></dd>
        </dl>
		<?php }?>
		<dl>
            <dt><?=$data['user_message_send']?><?=_('说：')?></dt>
        ...
        <dl class="foot">
            <dt>&nbsp;</dt>
            <dd><input type="submit" value="<?=_('提交')?>" class="submit bbc_btns"></dd>
        </dl>
    </form>
 </div>
</div>
