...
<div class="member_infor_content">
      <div class="tabmenu">
		<ul class="tab">
            ...
            <li class="active"><a href="<?= Yf_Registry::get('url') ?>?ctl=Buyer_Message&met=message&op=messageAnnouncement"><?=_('系统公告')?>(<?=$this->countMessage['article']?>)</a></li>
		   ...
		   <?php
            ...
            <tr class="bd-line">
              ...
              <td class="ncm-table-handle"><span>
				<span class="edit"><a  class="btn-bluejeans" dialog_width="550" dialog_title="<?=_('查看消息')?>" data-id="<?= $value['article_id'] ?>" href="javascript:void(0)" ><i class="iconfont iconf icon-chakan"></i><?=_('查看')?></a></span>
			  </td>
            </tr>
			<?php }?>
          </tbody>
