...
<div class="head">
	<div class="wrapper clearfix">
		<div class="head_left">
			<div id="login_top">
				<dl class="header_select_province">
					<dt><b class="iconfont icon-dingwei2"></b><span id="area"><?=_('上海')?></span></dt>
					<dd>
					</dd>
				</dl>
			</div>
		...
		<div class="head_right">
			<dl>
                                <p></p>
				<dt><a href="<?= Yf_Registry::get('url') ?>?ctl=Buyer_Order&met=physical"><?=_('我的订单')?></a></dt>
				<dd class="rel_nav">
					<a href="<?= Yf_Registry::get('url') ?>?ctl=Buyer_Order&met=physical"><?=_('实物订单')?></a>
					<a href="<?= Yf_Registry::get('url') ?>?ctl=Buyer_Order&met=virtual"><?=_('虚拟订单')?></a>
				</dd>
			</dl>
			...
			<dl>
                             <p></p>
				<dt><a href="<?= Yf_Registry::get('url') ?>?ctl=Buyer_Favorites&met=favoritesGoods" target="_blank"><span class="iconfont icon-taoxinshi bbc_color"></span><?=_('我的收藏')?></a></dt>
				<dd class="rel_nav">
					<a href="<?= Yf_Registry::get('url') ?>?ctl=Buyer_Favorites&met=favoritesShop"><?=_('店铺收藏')?></a>
					<a href="<?= Yf_Registry::get('url') ?>?ctl=Buyer_Favorites&met=favoritesGoods"><?=_('商品收藏')?></a>
					<a href="<?= Yf_Registry::get('url') ?>?ctl=Buyer_Favorites&met=footprint"><?=_('我的足迹')?></a>
				</dd>
			</dl>
			<dl>
                             <p></p>
				<dt>
					<a href="<?= Yf_Registry::get('url') ?>?ctl=Buyer_Cart&met=cart"><span class="iconfont icon-zaiqigoumai bbc_color"></span><?=_('购物车')?></a>
				</dt>
			</dl>
			<dl>
                             <p></p>
				<dt><a href="#"><?=_('客户服务')?></a></dt>
				<dd class="rel_nav">
					<a href="<?= Yf_Registry::get('url') ?>?ctl=Article_Base&met=index&article_id=2"><?=_('帮助中心')?></a>
					<a href="<?= Yf_Registry::get('url') ?>?ctl=Buyer_Service_Return&met=index"><?=_('售后服务')?></a>
					<a href="<?= Yf_Registry::get('url') ?>?ctl=Buyer_Service_Custom&met=index" target="_blank"><?=_('客服中心')?></a></dd>
			</dl>
			<dl>
                             <p></p>
				<dt><a href="#"><?=_('站点导航')?></a></dt>
				<dd class="rel_nav"><a href="#"><?=_('咨询频道')?></a><a href="index.php"><?=_('商城首页')?></a></dd>
			</dl>
			<dl>
