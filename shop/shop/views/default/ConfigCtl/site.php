    ...
    <div class="fixed-bar">
        <div class="item-title">
            ...
            <ul class="tab-base nc-row">
                <li><a class="current" <?= Yf_Registry::get('url') ?>?ctl=Config&met=site&config_type%5B%5D=site"><span>站点设置</span></a></li>
                ...
                <li><a href="<?= Yf_Registry::get('url') ?>?ctl=Config&met=district"><span>地区设置</span></a></li>
