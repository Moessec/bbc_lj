...
<form method="post" id="shop_api-setting-form" name="settingForm" class="nice-validator n-yellow" novalidate="novalidate">
    <div class="ncap-form-default">
        ...
        <dl class="row">
            <dt class="tit">
                <label for="site_name">广告图片</label>
            </dt>
            <dd class="opt">
                <img id="textfield2" name="textfield2" alt="选择图片" src="http://127.0.0.1/yf_shop_admin/shop_admin/static/default/images/default_user_portrait.gif" width="90px" height="90px">

                <div class="image-line upload-image" id="button2">上传图片</div>

                <input id="cat_adv_image" name="" value="" class="ui-input w400" type="hidden">
                <div class="notic">展示图片，建议大小90x90像素PNG图片。</div>
            </dd>
        </dl>
        ...
        <dl class="row">
            ...
            <dd class="opt">
                <input id="cat_adv_url" name="cat_adv_url" value="" class="ui-input w400" type="text">
...
<script>
    $(function() {
        ...
        if ( oper == 'edit' ) {
            ...
            $('#textfield2').prop('src', rowData.cat_adv_image);
            $('#mb_cat_image').val(rowData.mb_cat_image);
            $('#cat_adv_image').val(rowData.cat_adv_image);
            $('#cat_adv_url').val(rowData.cat_adv_url);
        }
        ...
        function postData() {
            ...
            var param = {
                ...
                cat_adv_image: $('#cat_adv_image').val(),
                cat_adv_url: $('#cat_adv_url').val()
            };
        ...
        new UploadImage({
            thumbnailWidth: 90,
            thumbnailHeight: 90,
            imageContainer: '#textfield2',
            uploadButton: '#button2',
            inputHidden: '#cat_adv_image'
        });
    });
</script>
