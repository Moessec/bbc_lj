...
<form id="article_form" method="post">
    <div class="ncap-form-default">
      ...
      <dl class="row">
        ...
        <dd class="opt">
            <img id="article_image" name="setting[article_logo]" alt="选择图片" src="./shop_admin/static/common/images/image.png" class="image-line" />
            <div class="image-line"  id="article_upload">上传图片<i class="iconfont icon-tupianshangchuan"></i></div>
            <input id="article_logo" name="setting[article_logo]" value="" class="ui-input w400" type="hidden"/>
        </dd>
      </dl>
    </div>
  </form>
...
$(function(){
    buyer_logo_upload = new UploadImage({
        thumbnailWidth: 240,
        thumbnailHeight: 60,
        imageContainer: '#article_image',
        uploadButton: '#article_upload',
        inputHidden: '#article_logo'
    });
})
</script>
