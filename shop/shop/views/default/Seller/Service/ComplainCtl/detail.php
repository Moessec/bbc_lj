...
?>
    ...
    <div class="tabmenu">
        <ul>
            <li class="active bbc_seller_bg"><a href="<?= Yf_Registry::get('url') ?>?ctl=Seller_Service_Complain&met=index"><?=_('投诉管理')?></a></li>
    ...
    <div class="ncsc-flow-layout">
        ...
        <div id="saleRefundReturn">
            ...
            <div class="ncsc-form-default">
                ...
                <dl>
                    <dt><?=_('商品名称：')?></dt>
                    <dd><a href="<?= Yf_Registry::get('url') ?>?ctl=Goods_Goods&met=goods&gid=<?= $data['good']['goods_id'] ?>" target="_blank"><?= $data['good']['goods_name'] ?></a></dd>
                </dl>
                <dl>
                    <dt><?=_('订单编号：')?></dt>
                ...
                <?php if ($data['complain_state_etext'] == "finish")
                { ?>
                    <h3><?=_('申诉详情')?></h3>
                    <dl>
                        <dt><?=_('申诉内容：')?></dt>
                ...
                elseif ($data['complain_state_etext'] == "appeal")
                { ?>
                        ...
                        <dl>
                            ...
                            <dd>
                                ...
                                <div id="uploader-demo">
                                    ...
                                    <div id="filePicker" class="bbc_seller_btns"><?=_('选择图片')?></div>
                                </div>
                            </dd>
                        </dl>
                        <dl class="foot">
                            <dt></dt>
                            <dd>
                                <input id="handle_submit" type="button" class="button button_red bbc_seller_submit_btns" value="<?=_('确认提交')?>">
                                <input id="handle_close" type="button" class="button button_red bbc_seller_submit_btns" value="<?=_('关闭投诉')?>"/>
                            </dd>
                        </dl>
                    </form>
                <?php }
                ...
                { ?>
                    ...
                    <form id="form" action="#" method="post">
                        ...
                        <dl class="foot">
                            ...
                            { ?>
                                <dd>
                                    <input id="handle_submit" type="button" class="button button_red" value="<?=_('提交冲裁')?>">
                                    <input id="handle_close" type="button" class="button button_red" value="<?=_('关闭投诉')?>"/>
                                </dd>
                            <?php } ?>
                        </dl>
                    </form>
        ...
        function get_complain_talk()
        {
            ...
            $.ajax({
                ...
                success: function (data)
                {
                    ...
                    {
                        $("#div_talk").append("<p class='admin'>" + "<?=_('目前没有对话')?>" + "</p>");
                    }
                },
                error: function ()
                {
