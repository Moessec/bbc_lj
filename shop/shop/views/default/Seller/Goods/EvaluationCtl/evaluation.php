            ...
            <div class="evaluation-timeline">
                ...
                <div class="date">
                    ...
                    <div class="goods_image">
                        <a target="_blank" href="<?= Yf_Registry::get('url') ?>?ctl=Goods_Goods&met=goods&gid=<?=($value[0]['goods_id'])?>"><img src="<?=image_thumb($value[0]['goods_image'],70,70)?>"/></a>
                    </div>
                    ...
                    <div class="order_goods">
                        ...
                        <!-- 商品名称 -->
                        <a target="_blank" href="<?= Yf_Registry::get('url') ?>?ctl=Goods_Goods&met=goods&gid=<?=($value[0]['goods_id'])?>"><?=($value[0]['goods_name'])?></a>
                        <!-- 商品价格 -->
                ...
                <dl class="detail detail_dls">
                  <dt class="clearfix">
                        <p><?=_('评论时间：')?><?=($value[0]['create_time'])?></p>
                        <span class="ml30">&nbsp;&nbsp;&nbsp;<?=_('商品评分：')?>
                            <em style="width: 100px;" title="<?=_('很满意')?>" class="raty" data-score="5">
                  ...
                  <span>
                    <a class="btnredpj bbc_seller_btns" href="<?= Yf_Registry::get('url') ?>?ctl=Seller_Goods_Evaluation&met=evaluation&evaluation_goods_id=<?=($value[0]['evaluation_goods_id'])?>"  id="explain"><i class=" bbc_seller_btns iconfont icon-shangjiaruzhushenqing"></i><?=_('解释')?></a>
                  </span>
                ...
                <?php if($value[0]['explain_content']): ?>
                    ...
                    <dl class="detail detail_dls">
                        <dt class="clearfix">
                             <p><?=_('解释时间：')?><?=($value[0]['update_time'])?></p>
                        </dt>
                ...
                <?php if(isset($value[1])):?>
                    ...
                    <dl class="detail detail_dls">
                      <dt class="clearfix">
                            <p><?=_('追加时间：')?><?=($value[1]['create_time'])?></p>
                      </dt>
                      ...
                      <span>
                        <a class="btnredpj bbc_seller_btns" href="<?= Yf_Registry::get('url') ?>?ctl=Seller_Goods_Evaluation&met=evaluation&evaluation_goods_id=<?=($value[1]['evaluation_goods_id'])?>"  id="explain"><i class=" bbc_seller_btns iconfont icon-shangjiaruzhushenqing"></i><?=_('解释')?></a>
                      </span>
                    ...
                    <?php if($value[1]['explain_content']): ?>
                        ...
                        <dl class="detail detail_dls">
                            <dt class="clearfix">
                                <p><?=_('解释时间：')?><?=($value[1]['update_time'])?></p>
                            </dt>
