...
<div class="form-style">
    <form method="post" id="form" action="<?=Yf_Registry::get('url')?>?ctl=Seller_Promotion_Voucher&met=editVoucherTemp&typ=e">
        ...
        <dl>
            <dt class="achieve_width_reset"><i>*</i><?=_('领取方式')?>：</dt>
            <dd>
                ...
                <p class="hint"><?=_('“积分兑换”时会员可以在积分中心用积分进行兑换')?>；</p>
                <p class="hint"><?=_('“免费领取”时会员可以点击店铺的代金券推广广告领取代金券')?>。</p>
            </dd>
        </dl>
        ...
        <dl>
            ...
            <dd>
                ...
                <p class="hint"><?=_('有效期应在套餐有效期内，使用的套餐有效期截止到')?> <?=$combo['combo_end_time']?></p>
            </dd>
        </dl>
        <dl>
            <dt><?=_('面额')?>：</dt>
            ...
            <dd>
                <select id="voucher_t_eachlimit" name="voucher_t_eachlimit" class="w70 vt valid">
                    <?php
                        ...
                        {
                    ?>
                    <option value="<?=($i)?>" <?=$i==@$data['voucher_t_eachlimit']?'selected':''?>><?=($i>0 || $data['voucher_t_eachlimit']==0)?$i.'张':'不限'?></option>
                    <?php  }?>
                </select>
            </dd>
        </dl>
        ...
        <dl>
            ...
            <dd>
                <div class="exchange_price">
					...
					<p class="hint"><?=_('店铺单笔订单满足多少元方可使用此代金券')?></p>
                </div>
            </dd>
        </dl>
        ...
        <dl>
            ...
            <dd>
                ...
                <p class="hint"><?=_('当会员兑换代金券时，需要达到该级别或者以上级别后才能兑换领取')?></p>
            </dd>
        </dl>
        <dl>
            <dt><i>*</i><?=_('代金券描述')?>：</dt>
        ...
        <dl>
            ...
            <dd>
                ...
                <p class="pic image_review" style="width:200px;height:200px;">
                    <img id="image_review" src="<?=@image_thumb($data['voucher_t_customimg'],200,200)?>" width="200" height="200"/>
                </p>
                <p class="upload-button">
					<input type="hidden" id="voucher_t_customimg" name="voucher_t_customimg" value="<?=@$data['voucher_t_customimg']?>" />
					<div  id='image_upload' class="lblock bbc_img_btns"><i class="iconfont icon-tupianshangchuan" ></i><?=_('图片上传')?></div>
				</p>
                <p class="hint"><?=_('此处图片将在代金券模块使用，建议尺寸200*200px')?>。</p>
            </dd>
        </dl>
        <dl>
            <dt></dt>
