    ...
    <form method="post" id="form" action="<?=Yf_Registry::get('url')?>?ctl=Seller_Promotion_Discount&met=add&typ=e">
        <dl>
            ...
            <dd>
                ...
                <p class="hint"><?=_('活动名称将显示在限时折扣活动列表中，方便商家管理使用，最多可输入25个字符')?>。
                </p>
            </dd>
        </dl>
        <dl>
            ...
            <dd>
                ...
                <p class="hint"><?=_('活动标题是商家对限时折扣活动的别名操作，请使用例如“新品打折”、“月末折扣”类短语表现，最多可输入10个字符')?>；</p>
                <p class="hint"><?=_('非必填选项')?>。</p>
            </dd>
        </dl>
        <dl>
            <dt><?=_('活动描述')?>：</dt>
            <dd>
                ...
                <p class="hint"><?=_('活动描述是商家对限时折扣活动的补充说明文字，在商品详情页-优惠信息位置显示')?>；</p>
                <p class="hint"><?=_('非必填选项，最多可输入30个字符')?>。</p>
            </dd>
        </dl>
        ...
        <dl>
            ...
            <dd>
                ...
                <?php if(!$shop_type){ ?>
                <p class="hint"><?=_('开始时间不能为空且不能早于')?><?=$combo['combo_start_time']?></p>
                <?php } ?>
            </dd>
        </dl>
        <dl>
            ...
            <dd>
                ...
                <?php if(!$shop_type){ ?>
                <p class="hint"><?=_('结束时间不能为空且不能晚于')?><?=$combo['combo_end_time']?></p>
                <?php } ?>
            </dd>
        </dl>
        <dl>
            ...
            <dd>
                ...
                <p class="hint"><?=_('参加活动的最低购买数量，默认为1')?></p>
            </dd>
        </dl>
