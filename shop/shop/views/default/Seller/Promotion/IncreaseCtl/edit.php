...
<table style="display:none;">
    <tbody id="goods-sku-item-tpl">
        <tr data-goods-id="__id">
            ...
            <td class="tl"><a href="<?=Yf_Registry::get('url')?>?ctl=Goods_Goods&met=goods&gid=__id" target="_blank"> __name </a></td>
                    ...
                    if(@$data['goods'])
                    {
                        foreach($data['goods'] as $key=>$goods)
                        {
                            ...
                            <tr data-goods-id="<?=@$goods['goods_id']?>">
                                ...
                                <td class="tl"><a href="<?=Yf_Registry::get('url')?>?ctl=Goods_Goods&met=goods&gid=<?=@$goods['goods_id']?>" target="_blank"> <?=@$goods['goods_name']?> </a></td>
                    ...
                    <div data-cou-level-item="<?=$key+1?>" class="inc-rule bbc-cou-rule mb10">
                        ...
                        <table class="table-list-style mt10">
                            ...
                            <tr>
                                ...
                                <th width="100"><?=_('原价')?></th>
                                <th width="100"><?=_('换购价')?></th>
                            ...
                            <tbody class="bd-line" id="cou-level-sku-container-<?=$key+1?>">
                                ...
                                <tr data-cou-level-selected-sku="<?=@$redpemp_goods['goods_id']?>" data-level="<?=$key+1?>">
                                    ...
                                    <td class="tl"><a href="<?=Yf_Registry::get('url')?>?ctl=Goods_Goods&met=goods&gid=<?=@$redpemp_goods['goods_id']?>" target="_blank"> <?=@$redpemp_goods['goods_name']?></a></td>
