...
<div class="exchange">
	...
	<form id="search_form" method="get" action="<?=Yf_Registry::get('url')?>?ctl=Seller_Promotion_Increase&met=index&typ=e">
        ...
        <select name="state">
            ...
            <option value="0" <?=request_int('state') == 0 ?'selected':''?>><?=_('全部')?></option>
	...
	<table class="table-list-style" id="table_list" width="100%" cellpadding="0" cellspacing="0">
        ...
        <tr class="row_line">
            ...
            <td>
                <span class="edit"><a href="<?=Yf_Registry::get('url')?>?ctl=Seller_Promotion_Increase&met=index&typ=e&op=edit&id=<?=@$value['increase_id']?>"><i class="iconfont icon-zhifutijiao"></i><?=_('编辑')?></a></span>
