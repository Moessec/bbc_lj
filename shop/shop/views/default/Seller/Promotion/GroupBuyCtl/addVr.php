    ...
    <form method="post" id="form" action="<?=Yf_Registry::get('url')?>?ctl=Seller_Promotion_GroupBuy&met=addVr&typ=e">
        ...
        <dl>
            ...
            <dd>
                ...
                <a class="button button_blue btn_show_search_goods bbc_seller_btns" href="javascript:void(0);"><?=_('选择商品')?></a>
        ...
        <dl>
            ...
            <dd>
                <p class="pic groupbuy_image_review" style="width:400px;height:400px;display:none;">
                    <img id="groupbuy_image_review" src="" height="400" width="400" />
                </p>
		...
		<dl>
			...
			<select id="area" name="area" class="w80"><option value=""><?=_('请选择')?>...</option></select>
			<!--<select id="mall" name="mall" class="w80"><option value="">请选择...</option></select>
			--><span></span>
			<p class="hint"><?=_('请选择本次虚拟团购所属地区')?></p>
			</dd>
		</dl>
