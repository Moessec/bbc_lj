...
<div class="exchange">
	...
	<table class="table-list-style table-promotion-list" width="100%" cellpadding="0" cellspacing="0">
        ...
        ?>
        <tr>
            <td width="50"><a href="<?=Yf_Registry::get('url')?>?ctl=GroupBuy&met=detail&id=<?=$value['groupbuy_id']?>&typ=e" target="_blank"><img src="<?=image_thumb($value['groupbuy_image'],30,30)?>" width="30" height="30"></a></td>
            <td class="tl"><a href="<?=Yf_Registry::get('url')?>?ctl=GroupBuy&met=detail&id=<?=$value['groupbuy_id']?>&typ=e" target="_blank"><?=$value['groupbuy_name']?></a></td>
