...
<div class="exchange">
	<div class="alert">
		...
		<ul>
			<li>1、<?=_('点击购买套餐或续费套餐可以购买或续费套餐')?></li>
			<li>2、<?=_('已参加限时折扣、团购的商品，可同时参加满即送活动')?>。</li>
	...
	<table class="table-list-style table-promotion-list" id="table_list" width="100%" cellpadding="0" cellspacing="0">
		<tr>
			<th class="tl" width="250"><?=_('活动名称')?></th>
        ...
        <tr class="line_row">
            ...
            <td>
                <span class="edit"><a href="<?=Yf_Registry::get('url')?>?ctl=Seller_Promotion_MeetConditionGift&met=index&op=detail&typ=e&id=<?=@$value['mansong_id']?>"><i class="iconfont icon-btnclassify2"></i><?=_('详细')?></a></span>
                <span class="del"><a data-param="{'ctl':'Seller_Promotion_MeetConditionGift','met':'removeManSong','id':'<?=@$value['mansong_id']?>'}" href="javascript:void(0)"><i class="iconfont icon-lajitong"></i><?=_('删除')?></a></span>
            </td>
        </tr>
        <?php
            }
