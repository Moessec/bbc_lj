...
?>
    ...
    <a href="javascript:;" id="upload-image" class="ui-btn ui-btn-success bbc_seller_btns"><i class="rel_top1 iconfont icon-jia"></i>上传图片</a>
        ...
        <div class="category-container">
            <div>
                ...
                <div class="text-center">
                    <a href="javascript:;" id="add-album" class="ui-btn text-center">+ 添加分组</a>
                </div>
            </div>
        </div>
    ...
    <div class="action-bar clearfix">
        <label class="inline"><input type="checkbox" id="select-all"><a class="f12">全选</a></label><span>|</span>
        <a href="javascript:;" id="bulk-edit" class="batch-opt c-gray" style="cursor: not-allowed;">
            <i class="iconfont icon-zhifutijiao f18 rel_top2"></i>修改分组
        </a><span>|</span>
        <a href="javascript:;" id="bulk-remove" class="batch-opt c-gray" style="cursor: not-allowed;">
            <i class="iconfont icon-lajitong rel_top2"></i>删除
        </a>
