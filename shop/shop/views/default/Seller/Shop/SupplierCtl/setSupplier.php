...
<body>
	...
	<div class="tabmenu">
		<ul>
        	<li ><a href="./index.php?ctl=Seller_Shop_Supplier&met=supplier&typ=e"><?=_('供货商')?></a></li>

            <?php if($act == 'add') {?>
            <li  class="active bbc_seller_bg"><a href="javascript:void(0);"><?=_('添加供货商')?></a></li>
            <?php }
            if($act == 'edit'){?>
            <li class="active bbc_seller_bg"><a href="javascript:void(0);"><?=_('编辑供货商')?></a></li>
            <?php }?>
        </ul>
    </div>
    <?php if($act == 'add') {?>
