...
<div class="ncsc-store-templet">
    <?php if($default_temp){ ?>
        <dl class="current-style">
          ...
          <dd><?=_('店铺模版名称：')?><strong id="current_template"><?=$default_temp['shop_style_name']?></strong></dd>
          <dd><?=_('店铺风格名称：')?><strong id="current_style"><?=$default_temp['shop_temp_name']?></strong></dd>
          <dd><?=_('店铺名称：')?><strong><?=$re['shop_name']?></strong></dd>
          <dd><a href="index.php?ctl=Shop&met=index&id=<?=$re['shop_id']?>" class="yfbtn bbc_seller_btns"><?=_('店铺首页')?></a></dd>
        </dl>
    <?php }?>
  <h3><?=_('图片上传')?>可用主题</h3>
    ...
    <ul>
       ...
       <li>
        <dl>
          ...
          <dd><?=_('模版名称：')?><?=$value['shop_temp_name']?></dd>
          <dd><?=_('风格名称：')?><?=$value['shop_style_name']?></dd>
          <dd class="btn"> <a href="javascript:use_theme('<?=$value['shop_temp_name']?>');" class="yfbtn bbc_seller_btns"><i class="icon-cogs"></i><?=_('使用')?></a> <a href="javascript:preview_theme('<?=$value['shop_temp_name']?>');" class="yfbtn bbc_seller_btns"><i class="icon-zoom-in "></i><?=_('预览')?></a> </dd>
        </dl>
      </li>
               <?php }}?>
          </ul>
