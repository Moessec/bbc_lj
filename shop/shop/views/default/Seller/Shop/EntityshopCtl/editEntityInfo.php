...
<div class="eject_con" id="eject_con">
  <form id="form" method="post" action="#" >
    ...
    <dl>
      <dt><i class="required">*</i><?=_('实体店铺名称：')?></dt>
      <dd>
          <input class="text w200"   style=" height: 30px;" type="text" name="entity[entity_name]" value="<?=$entity_info['entity_name']?>" />
        <p class="hint"><?=_('不同地址建议使用不同名称以示区别，如“山西面馆(水游城店)”。')?></p>
      </dd>
    </dl>
    <dl>
      <dt><i class="required">*</i><?=_('详细地址：')?></dt>
      <dd>
        ...
        <p class="hint"><?=_('为了准确定位建议地址加上所在城区名字，如“红桥区大丰路18号水游城”。')?></p>
      </dd>
    </dl>
    <dl>
      <dt><?=_(' 联系电话：')?></dt>
