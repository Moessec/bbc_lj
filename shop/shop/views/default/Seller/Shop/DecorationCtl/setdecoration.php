...
<div id="dialog_edit_background" class="eject_con dialog-decoration-edit" style="display:none;">
  ...
  <dl>
    ...
    <dd>
        ...
        <div  id='icon-upload-alt'  ><i class="iconfont icon-tupianshangchuan" style="color:#fff;"></i><?=_('图片上传')?></div></p>
      <div id="div_background_image"  class="background-image-thumb"> <img id="img_background_image" src="<?php echo $decoration_detail['decoration_setting']['background_image_url'];?>" alt="">
        ...
        <a id="btn_del_background_image" class="del" href="javascript:void(0);" title="<?=_('移除背景图')?>">X</a></div>
    </dd>
  </dl>
  <dl>
    <dt><?=_('背景图定位：')?></dt>
        ...
        <dd>
          <div id="div_banner_image"  class="background-image-thumb"> <img id="img_banner_image" src="<?php echo $decoration_detail['decoration_banner']['image_url'];?>" alt="">
            ...
            <a id="btn_del_banner_image" class="del" href="javascript:void(0);" title="<?=_('移除')?>">X</a> </div>
             ...
             <div  id='ncsc-upload-btn'  ><i class="iconfont icon-tupianshangchuan" style="color:#fff;" ></i><?=_('图片上传')?></div></p>
...
<div id="dialog_module_slide" class="eject_con dialog-decoration-edit" style="display:none;">
  ...
  <dl class="display-set">
    ...
    <dd><span><?=_('全屏显示')?>
      ...
      </span><span><strong class="orange">*</strong> <?=_('显示高度')?>
      <input id="txt_slide_height" type="text" class="text w40" value=""><em class="add-on"><?=_('像素')?></em></span>
    ...
    <form action="">
      ...
      <dl>
        ...
        <dd>
          ...
          <p class="mt5"><a id="btn_save_add_slide_image" class="ncsc-btn ncsc-btn-acidblue alert_btns_reset mr10 bbc_seller_btns" href="javascript:void(0);"><?=_('添加')?></a> <a id="btn_cancel_add_slide_image" class="ncsc-btn ncsc-btn-orange alert_btns_reset bbc_gray_btns" href="javascript:void(0);"><?=_('取消')?></a></p>
        </dd>
      </dl>
    </form>
  </div>
			...
			<dl>
			  ...
			  <dd>
                                ...
                                <img style="max-width:400px;max-height: 150px;" id="img_hot_image" src="" alt="" > 
                                  ...
                                  <p id="icon-hot-alt"><i class="iconfont icon-tupianshangchuan" style="color:#fff;"></i><?=_('图片上传')?></p>

				<p class="hint"><?=_('选择上传jpg/gif/png格式图片，建议宽度不超过1000像素，高度不超过400像素，如超出此范围，请先自行对图片进行裁切调整。')?></p>
			  </dd>
			</dl>
		  </form>
		  <dl>
		...
		<div id="dialog_module_goods" class="eject_con dialog-decoration-edit" style="display:none;">
		  ...
		  <div class="decoration-search-goods">
			  ...
			  <input id="txt_goods_search_keyword" type="text" class="text w200 vm" name="">
                          <a id="btn_module_goods_search" class="ncbtn button" href="javascript:void(0);"><i style ="color:#000000;"class="iconfont icon-btnsearch"></i><?=_('搜索')?></a><span class="ml10" style="margin-left:10px;color:orange;margin-top: 5px;"><?=_('小提示： 留空搜索显示10个商品，可做搜索操作。')?></span></div>
			<div id="div_module_goods_search_list"></div>
		  </div>
                  <div class="bottom" style="clear: both;"><label class="submit-border"><a id="btn_save_module_goods" class="submit bbc_seller_submit_btns" href="javascript:void(0);"><?=_('保存设置')?></a></label></div>
		</div>
		<!-- 幻灯模板 --> 
