    ...
    <dl>
      ...
      <dd>
        ...
        <label for="store_decoration_switch_off">
          ...
          <?=_('否')?></label>
        <p class="hint"><?=_('选择是否使用店铺装修模板；')?><br/>
          <?=_('如选择“是”，店铺首页背景、头部、导航以及上方区域都将根据店铺装修模板所设置的内容进行显示；')?><br/>
          <?=_('如选择“否”根据')?> <a href="index.php?ctl=Seller_Shop_Setshop&met=theme&typ=e"><?=_('“店铺主题”')?></a> <?=_('所选中的系统预设值风格进行显示。')?></p>
      </dd>
    </dl>
    <dl>
      <dt><?=_('仅显示装修内容：')?></dt>
      <dd>
        ...
        <label for="store_decoration_only_off">
          ...
          <?=_('否')?></label>
        <p class="hint"><?=_('该项设置如选择“是”，则店铺首页仅显示店铺装修所设定的内容；')?><br/>
         <?=_('如选择“否”则按标准默认风格模板延续显示页面下放内容，即左侧店铺导航、销售排行，右侧轮换广告、最新商品、推荐商品等相关店铺信息。')?> </p>
      </dd>
    </dl>

    <dl>
      <dt><?=_('店铺装修：')?></dt>
      <dd> <a href="index.php?ctl=Seller_Shop_Decoration&met=decoration&act=set&typ=e&" class="ncbtn ncbtn-aqua mr5 bbc_seller_bg" style="margin-left: 0px;color:#ffffff;" target="_blank"><i class="icon-puzzle-piece"></i><?=_('装修页面')?></a> 
<!--          <a id="btn_build" href="" class="ncbtn ncbtn-bittersweet" target="_blank"><i class="icon-magic"></i>生成页面</a>-->
        <p class="hint"><?=_('点击“装修页面”按钮，在新窗口对店铺首页进行装修设计；')?><br/>
       </p>
      </dd>
    </dl>
    <div class="bottom">
      <label class="submit-border">
          <input  type="submit" class="bbc_seller_submit_btns" value="<?=_('提交')?>" />
      </label>
    </div>
  </form>
</div>
