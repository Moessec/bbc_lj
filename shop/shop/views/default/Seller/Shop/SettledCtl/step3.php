...
<form id="form_company_info" method="post">
    ...
    <fieldset>
        ...
        <dl>
            <dt><i>*</i>银行开户名：</dt>
            <dd><input class="text w250" name="bank_account_name" type="text"></dd>
        </dl>
        <dl>
            <dt><i>*</i>公司银行账号：</dt>
            <dd><input class="text w250" name="bank_account_number" type="text"></dd>
        </dl>
        <dl>
            <dt><i>*</i>开户银行支行名称：</dt>
            <dd><input class="text w250" name="bank_name" type="text"></dd>
        </dl>
        <dl>
            <dt>开户银行支行联行号：</dt>
            <dd><input class="text w250" name="bank_code" type="text"></dd>
        </dl>
        <dl>
            <dt><i>*</i>开户银行支行所在地：</dt>
        ...
        <dl>
            ...
            <dd>
                <input class="text w250 mr10" style="float: left;" readonly="readonly" id="bank_licence_electronic" name="bank_licence_electronic" type="text">
    ...
    <fieldset>
        ...
        <dl>
            <dt><i>*</i>税务登记证号：</dt>
            <dd><input class="text w250" name="tax_registration_certificate" type="text"></dd>
        </dl>
        <dl>
            <dt><i>*</i>纳税人识别号：</dt>
            <dd><input class="text w250" name="taxpayer_id" type="text"></dd>
        </dl>
        <dl>
            <dt><i>*</i>税务登记证号电子版：</dt>
            <dd>
            
            <input class="text w250 mr10" style="float: left;" id="tax_registration_certificate_electronic" name="tax_registration_certificate_electronic" readonly="readonly" type="text">
            <p style="float:left; width:70px"  id="tax_registration_certificate_upload" ><i class="iconfont icon-upload-alt"></i>图片上传</p>
            <p  style="clear:both" class="hint">请确保图片清晰，文字可辨并有清晰的红色公章。</p>
            </dd>
        </dl>
    </fieldset>
    <div class="next"><a class="button bbc_btns" id="btn_apply_company_next" href="javascript:;">下一步，填写入驻预经营信息</a></div>
</form>    
</div>
  </div>
</div>
