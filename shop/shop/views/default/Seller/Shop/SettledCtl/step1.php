...
<div class="breadcrumb"><span class="icon-home iconfont icon-tabhome"></span><span><a href="index.php"><?=_('首页')?></a></span> <span class="arrow iconfont icon-btnrightarrow"></span> <span><?=_('商家入驻申请')?></span> </div>
<div class="main">
  <div class="sidebar">
    <div class="title">
      <h3><?=_('商家入驻申请')?></h3>
    ...
    <div class="content">
        ...
        <dd style="display: none;">
          <ul>
                        ...
                        <li> <i></i>
                            <a href="" target="_blank"><?=_('商家信息提交')?></a>
                          </li>
                        <li> <i></i>
                            <a href="" target="_blank"><?=_('平台审核资质')?></a>
                          </li>
                        <li> <i></i>
                            <a href="" target="_blank"><?=_('商家缴纳费用')?></a>
                          </li>
                        <li> <i></i>
    ...
    <div class="content">
      <ul>
                <li><?=_('电话1：23456789')?></li>
                <li><?=_('电话2：88997788')?></li>
                <li><?=_('邮箱：abc@bbc-builder.net')?></li>
      </ul>
    </div>
  </div>
...
$(document).ready(function(){
    $('#btn_apply_agreement_next').on('click', function() {
        if($('#input_apply_agreement').prop('checked')) {
            window.location.href = "index.php?ctl=Seller_Shop_Settled&met=index&op=step2";
        } else {
            alert('请阅读并同意协议');
        }
    });
