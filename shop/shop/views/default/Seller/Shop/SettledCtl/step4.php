...
<form id="form_company_info" method="post">
    ...
    <fieldset>
        ...
        <dl>
            <dt><i>*</i>店铺名称：</dt>
            <dd>
                <input class="text w250" name="shop_name" type="text" value="">
            ...
            <select name="shop_grade_id">
                <option selected="selected" value="">请选择</option>
                                 <?php if(!empty($shop_grade)){
                                    ...
                                    ?>
                                    <option value="<?=$value['shop_grade_id']?>"><?=$value['shop_grade_name']?> (收费标准：<?=$value['shop_grade_fee']?> 元)</option>
    ...
    <div class="next"><a id="btn_apply_company_next" class="button bbc_btns" href="javascript:void(0);">提交申请</a></div>
</form>    
...
$(document).ready(function(){
         var ajax_url = './index.php?ctl=Seller_Shop_Settled&met=editShopBase&typ=json';
           ...
           valid:function(form){
                ...
                $.ajax({
                    ...
                    success:function(a){
                        if(a.status == 200)
                        {
                           location.href="./index.php?ctl=Seller_Shop_Settled&met=index&op=step5"; 
                        }
                        else
                        {
                            alert('操作失败！');
