...
?>
	...
	<div class="tabmenu">
		<ul>
        	<li class="active bbc_seller_bg"><a href="./index.php?ctl=Seller_Shop_Cat&met=cat&typ=e"><?=_('店铺分类')?></a></li>

        </ul>
        <a class="button add button_blue bbc_seller_btns" href="./index.php?ctl=Seller_Shop_Cat&met=cat&act=add&typ=e"><i class="iconfont icon-jia"></i><?=_('添加分类')?></a>
       ...
       <table class="table-list-style" width="100%" cellpadding="0" cellspacing="0">
        ...
        <tr class="row_line">
            ...
            <td class="nscs-table-handle">
                <span class="edit"><a href="./index.php?ctl=Seller_Shop_Cat&met=cat&act=edit&pid=<?=$value['shop_goods_cat_id']?>&typ=e"><i class="iconfont icon-zhifutijiao"></i><?=_('编辑')?></a></span>
                <span class="delparent del" ><a data-param="{'ctl':'Seller_Shop_Cat','met':'delCat','id':'<?=$value['shop_goods_cat_id']?>'}" href="javascript:void(0)"><i class="iconfont icon-lajitong"></i><?=_('删除')?></a></span>
                <span class="del_line"><a href="./index.php?ctl=Seller_Shop_Cat&met=cat&act=add&typ=e&pid=<?=$value['shop_goods_cat_id']?>"><i class="iconfont  icon-jia"></i><?=_('下级')?></a></span>
            </td>
        </tr>
        ...
        <tr class="row_line row_line_dash" >
            ...
            <td class="nscs-table-handle" style="text-align: right;">
                <span class="edit"><a href="./index.php?ctl=Seller_Shop_Cat&met=cat&act=edit&pid=<?=$values['shop_goods_cat_id']?>&typ=e"><i class="iconfont icon-zhifutijiao"></i><?=_('编辑')?></a></span>
                <span class="del"><a data-param="{'ctl':'Seller_Shop_Cat','met':'delCat','id':'<?=$values['shop_goods_cat_id']?>'}" href="javascript:void(0)"><i class="iconfont icon-lajitong"></i><?=_('删除')?></a></span>
            </td>
        </tr>
         <?php }}} ?>
            <!--- 分页 --->
     ...
     <?php }?>
        ...
        <tr>
            ...
            <span>|</span>
            <label class="del"><a data-param="{'ctl':'Seller_Shop_Cat','met':'delAllCat'}" href="javascript:void(0)"><i class="iconfont icon-lajitong"></i><?=_('删除')?></a></label>
...
<script>
    ...
    $('span.delparent a').click(function(){
        ...
        if(confirm('<?=_('删除一级分类，下面的子类也会删除，您确定要删除吗？')?>')) {
