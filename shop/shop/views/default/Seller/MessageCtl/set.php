...
<div class="eject_con">
    <div id="warning" class="alert alert-error"></div>
            <form id="form" action="#" method="post">
                ...
                <dl>
                    <dt><input class="checkbox mr5" name = "force_mail" type="checkbox" checked disabled><?=_('商家消息提醒：')?></dt>
                    <dd>
                        <p><?=_('系统将自动发送站内消息给商家。')?></p>
                    </dd>
                </dl>
                <div class="bottom">
                    <input  type="submit" id="handle_submit" class="button bbc_seller_submit_btns" value="<?=_('提交')?>"/>
                </div>
            </form>
</div>
