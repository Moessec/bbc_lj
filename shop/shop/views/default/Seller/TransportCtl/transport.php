...
<div class="freight">
	<div class="tabmenu">
        ...
        <a class="button add bbc_seller_btns" href="<?=Yf_Registry::get('url')?>?ctl=Seller_Transport&met=transport&act=add"><i class="iconfont icon-jia bbc_seller_btns"></i><?=_('添加运费模版')?></a>
    ...
    <tr>
        <th class="tl"><label class="checkbox"><input class="checkall" type="checkbox" /></label>模板名称</th>
        <th width="200"><?=_('配送区域')?></th>
    ...
    <tr class="row_line">
        ...
        <td>
            <span class="edit"><a href="<?=Yf_Registry::get('url')?>?ctl=Seller_Transport&met=transport&act=edit&transport_type_id=<?=($value['transport_type_id'])?>"><i class="iconfont icon-zhifutijiao"></i><?=_('编辑')?></a></span>
