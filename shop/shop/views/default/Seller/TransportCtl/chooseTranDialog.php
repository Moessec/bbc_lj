                ...
                <?php if ( !empty($transport_list) ) { ?>
                    <?php foreach ( $transport_list as $key => $val ) { ?>
                        <tr class="bd-line">
                            ...
                            <td><?= $val['transport_item']['district_name']; ?></td>
                            <td class="tc"><?php if ( !empty($val['transport_item']['transport_item_default_num']) ) { echo $val['transport_item']['transport_item_default_num']; } ?></td>
                            <td class="tc"><?= $val['transport_item']['transport_item_default_price']; ?></td>
                            <td class="tc"><?= $val['transport_item']['transport_item_add_num']; ?></td>
                            <td class="tc"><?= $val['transport_item']['transport_item_add_price']; ?></td>
                            <td class="tc">
