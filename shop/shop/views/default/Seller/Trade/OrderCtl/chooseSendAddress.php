        ...
        <div class="adds" style=" min-height:240px;">
            <table class="ncsc-default-table">
                ...
                <tr class="bd-line">
                    ...
                    <td class="tc"><a href="javascript:void(0);" nc_type="select" class="ncbtn bbc_seller_btns" address_id="<?= $val['shipping_address_id']; ?>" address_value="<?= $val['address_value']; ?>">选择</a></td>
                </tr>
                <?php } ?>
                <?php } ?>
                </tbody>
