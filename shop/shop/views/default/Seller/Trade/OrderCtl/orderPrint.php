    ...
    <div class="print-page">
        <div id="printarea">
            <div class="orderprint">
                <div class="top">
                    <div class="full-title"><?= $data['shop_name']; ?> 发货单</div>
                </div>
                <table class="buyer-info">
                    <tbody><tr>
                        <td class="w200">收货人：<?= $data['buyer_user_name']; ?></td>
                        <td>电话：<?= $data['order_receiver_contact']; ?></td>
                        <td></td>
                    </tr>
                    <tr>
                        <td colspan="3">地址：<?= $data['order_receiver_address']; ?></td>
                    </tr>
                    <tr>
                        <td>订单号：<?= $data['order_id']; ?></td>
                        <td>下单时间：<?= $data['order_create_time']; ?></td>
                        <td></td>
                    </tr>
                    </tbody></table>
                <table class="order-info">
                    ...
                    <tfoot>
                    <tr>
                        <th colspan="10"><span>总计：¥<?= $data['order_payment_amount']; ?></span><span>运费：¥<?= $data['order_shipping_fee']; ?></span><span>优惠：¥<?= $data['order_discount_fee']; ?></span><span>订单总额：¥<?= $data['order_goods_amount']; ?></span><span>店铺：<?= $data['shop_name']; ?></span>
                        </th>
                    </tr>
                    </tfoot>
                </table>
                <div class="explain">
                    <?php if ( !empty($shop_stamp) ) { ?>
                        <img src="<?= $shop_stamp = $shop_base['shop_stamp']; ?> alt="店铺印章" />
                    <?php } else { ?>
                        <b style="color: red">请设置店铺印章后，再打印单据</b>
                    <?php } ?>
