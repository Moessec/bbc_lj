...
<div id="mainContent">
    ...
    <div class="">
        ...
        <form name="deliver_form" method="POST" id="deliver_form">
            ...
            <div class="alert alert-success">您可以通过"发货设置-&gt;<a href="<?= $default_express_url; ?>" target="_parent">默认物流公司</a>"添加或修改常用货运物流。免运可切换下方<span class="red">[无需物流运输服务]</span>选项卡并操作。
            </div>
            <div class="tabmenu">
                <ul class="tab pngFix">
            ...
            <table class="ncsc-default-table order" id="texpress1">
                ...
                <tr>
                    ...
                    <td class="bdl bdr tc"><a nc_value="<?= $val['user_express_id']; ?>" href="javascript:void(0);" class="ncbtn bbc_seller_btns">确认</a></td>
                </tr>
                <?php } ?>
                <?php } ?>
                </tbody>
            ...
            <table class="ncsc-default-table order" id="texpress2" style="display:none">
                ...
                <tr>
                    ...
                    <td class="bdr tl w400"> <a nc_type="eb" nc_value="e1000" href="javascript:void(0);" class="ncbtn bbc_seller_btns">确认</a>
                    </td>
                </tr>
                <tr>
                    <td colspan="2"></td>
