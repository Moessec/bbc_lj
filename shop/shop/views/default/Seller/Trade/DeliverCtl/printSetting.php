        ...
        <div class="form-style">
			...
			<dl>
                ...
                <dd>
                    ...
                    <p class="hint"><?=_('打印备注信息将出现在打印订单的下方位置，用于注明店铺简介或发货、退换货相关规则等；内容不要超过100字。')?></p>
                </dd>
            </dl>
			...
			<dl>
				...
				<dd>
                     ...
                     <p class="upload-button">
                        ...
                        <div  id='logo_upload' class="lblock bbc_img_btns" style=""><i class="iconfont icon-tupianshangchuan"></i><?=_('图片上传')?>
                        </div>
                     </p>
					 <p class="hint"><?=_('印章图片将出现在打印订单的右下角位置，请选择120x120px大小透明GIF/PNG格式图片上传作为您店铺的电子印章使用。')?></p>
				</dd>
            </dl>
