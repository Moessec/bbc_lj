        ...
        <tr class="bd-line">
            ...
            <td class="tl">
                ...
                <div class="waybill-img-size">
                    <p>宽度：<?php echo $val['waybill_tpl_width']; ?>(mm)</p>
                    <p>高度：<?php echo $val['waybill_tpl_height']; ?>(mm)</p>
            </div></td>
            <td class="tl">用户模板</td>
            <td class="nscs-table-handle">
                <span>
                    <a href="javascript:;" class="btn-aqua" target="_blank">
                        <i class="iconfont icon-icontianping"></i><p>测试</p>
                    </a>
                </span>
                <span>
                    <a href="javascript:;" nctype="btn_bind" class="btn-mint" data-waybill_tpl_id="<?php echo $val['waybill_tpl_id']; ?>">
                        <i class="iconfont icon-banshou"></i><p>绑定</p>
                    </a>
                </span>
            </td>
        </tr>
