    ...
    <form method="post" id="form" class="nice-validator n-yellow" novalidate="novalidate">
        ...
        <dl>
            ...
            <dd>
                ...
                <div id="btn_upload_img" style="width: 200px;"></div>
        ...
        <dl>
            ...
            <dd>
                <ul class="ncsc-form-radio-list">
                    <li>
                        <label for="waybill_usable_1"><input id="waybill_usable_1" type="radio" name="waybill_usable" value="1"> 是</label>
                    </li>
                    <li>
                        <label for="waybill_usable_0"><input id="waybill_usable_0" type="radio" name="waybill_usable" value="0" checked=""> 否</label>
                    </li>
                </ul>
