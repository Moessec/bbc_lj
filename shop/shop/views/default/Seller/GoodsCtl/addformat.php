    ...
    <?php if($act == 'edit' && $data){?>
        <form id="form" action="#" method="post" >
            ...
            <div class="form-style">
                ...
                <dl class="row">
                    <dt class="tit">
                        <span style="margin-right:5px;"><i>*</i>版式位置:</span>
                    </dt>
                    <select name="position" class="selected_edit">
                        <option value="<?=Goods_FormatModel::FORMAT_POSITION_TOP?>" <?=Goods_FormatModel::FORMAT_POSITION_TOP==@$data['position']?'selected':''?>>顶部</option>
                        <option value="<?=Goods_FormatModel::FORMAT_POSITION_BOTTOM?>" <?=Goods_FormatModel::FORMAT_POSITION_BOTTOM==@$data['position']?'selected':''?>>底部</option>
                    </select>
                </dl>
                <dl class="row">
                    <dt class="tit">
                        <label><i>*</i>板式内容:</label>
                    </dt>
                    <dd class="opt">
                        <!-- 加载编辑器的容器 -->
                ...
                <dl>
                    <dt></dt>
                    <dd><input type="submit" class="button button_red bbc_seller_submit_btns" value="确认提交" /></dd>
                </dl>
            </div>
        </form>
    <?php }
        ...
        <form id="form" action="#" method="post" >
            <div class="form-style">
                ...
                <dl class="row">
                    ...
                    <select name="position" class="selected_edit">
                        <option value="<?=Goods_FormatModel::FORMAT_POSITION_TOP?>" <?=Goods_FormatModel::FORMAT_POSITION_TOP==@$_GET['position']?'selected':''?>>顶部</option>
                        <option value="<?=Goods_FormatModel::FORMAT_POSITION_BOTTOM?>" <?=Goods_FormatModel::FORMAT_POSITION_BOTTOM==@$_GET['position']?'selected':''?>>底部</option>
                    </select>
                </dl>
                <dl class="row">
                    <dt class="tit">
