    ...
    <div class="mod-inner"  style="width:480px; ">
        ...
        <div id="import-wrap" class="cf">
            <div id="import-step1" class="step-item">
                ...
                <p><a href="<?= Yf_Registry::get('index_page') ?>?ctl=Seller_Goods&met=downloadTemplate&typ=e" class="link">下载导入模板（适合大部分行业）</a></p>
                <div class="step-btns">
            ...
            <div id="import-step2" class="step-item" style="display:none;">
                <div class="ctn file-import-ctn">
                    ...
                    <span style="top: 10px;" id="import-btn" class="mrb">浏览</span>
                </div>
                <div class="step-btns">
            ...
            <div id="import-step3" class="step-item" style="display:none;">
                ...
                <div class="step-btns">
                    <a href="#" class="link ui-btn mrb" id="a_step3">上一步</a><a href="#" class="ui-btn ui-btn-sp" id="btn-complete">完成</a>
                </div>
            </div>
        </div>
    </div>
...
<script type="text/javascript">
    (function (){
        ...
        $('#btn-import').on('click',function(e){
            e.preventDefault();
            if(!$('#file-path').val()){
                parent.Public.tips.error({content : '请选择要上传的文件！', type : 2});
                return ;
            }
            progressPop = parent.$.dialog.tips('正在导入凭证，请耐心等待...',1000,'loading.gif',true).show();
        ...
        function uploadSuccess(data){
            importDialog = parent.$.dialog.tips('正在导入商品，请耐心等待...',1000,'loading.gif',true).show(); //导入商品的时候
            $.post( SITE_URL + "?ctl=Seller_Goods&met=importGoods&typ=json", {'url_path': data.url_path},
                function ( data ) {
                    importDialog.close();
                    parent.Public.tips.success('导入完成！');
