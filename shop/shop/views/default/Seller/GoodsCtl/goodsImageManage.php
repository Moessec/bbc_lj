    ...
    <div class="goods">
        ...
        <div class="form-style">
            <div class="form-style-left">
                <form method="post" id="form" action="<?php echo Yf_Registry::get('url') . '?ctl=Seller_Goods&met=saveGoodsImage&typ=json&common_id=' . $common_id; ?>">
                    <?php if( empty($color) ) { ?>
                    ...
                    <table class="image-list-table" cellpadding="5" cellspacing="1">
                                ...
                                <tr>
                                    <td>
                                        ...
                                        <div class="fore2">
                                            <p><i class="icon-ok-circle"></i><span>设为主图</span><input type="hidden" name="image[<?= $key ?>][0][default]" value="1"></p>
                                            <a href="javascript:void(0)" nctype="del" class="del" title="移除">X</a>
                                        </div>
...
<script>
    ...
    $('.fore2').on('click', 'p', function () {
        ...
        $('.fore2.bbc_seller_border').removeClass('bbc_seller_border').find('p').css('display', '').find('span').html('设为主图');
