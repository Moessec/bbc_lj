<?php if (!defined('ROOT_PATH')){exit('No Permission');}
	...
	$keywords = current(explode(',',  Web_ConfigModel::value('search_words')));
			...
			<div class="nav_right clearfix">
				...
				<div class="clearfix">
                                    <form name="form_search" id="form_search" action="">
                                        ...
                                        <input name="keywords" id="site_keywords" value="<?=Web_ConfigModel::value('search_words')?>"  type="text" class="bbc_border" onclick="this.value = '';" >
                                        <input type="submit" style="display: none;" >
                                    </form>
                                    <a href="#" class="ser bbc_bg_col" id="site_search"><?=('搜索')?></a>
                                        <!-- 购物车 -->
				...
				<div class="nav clearfix">
                                    <?php 
                                    foreach ($this->searchWord as $key => $v) {
                                        
                                   
                                    ?>
                                    <a href="<?= Yf_Registry::get('url') ?>?ctl=Goods_Goods&met=goodslist&typ=e&keywords=<?=  urlencode($v['search_keyword']) ?>"><?=$v['search_keyword'] ?></a>
                                    <?php }?>
                                </div>
			</div>
			<div style="clear:both;"></div>
		...
		<div>
			<div class="thead clearfix">
				<div class="classic clearfix">
					<div  class="class_title bbc_bg"><span>&equiv;</span><a href="index.php?ctl=Goods_Cat&met=goodsCatList" class="ta1">全部分类</a></div>
						...
						<ul>
							...
							<li>
                                                                        ...
                                                                        <div class="channels">
                                                                              <?php if(!empty($catone['brand'])){
                                                                                    foreach ($catone['brand'] as $brand_key => $brand_value) {
                                                                                        ...
                                                                                        ?>
                                                                                     <a href="index.php?ctl=Goods_Goods&met=goodslist&debug=1&brand_id=<?=$brand_value['brand_id']?>"><?=$brand_value['brand_name']?><span class="iconfont icon-iconjiantouyou "></span></a>
                                                                                 <?php } } }?>
											...
											<dl class="clearfix"><dt>
												<a href="index.php?ctl=Goods_Goods&met=goodslist&debug=1&cat_id=<?=$value['cat_id']?>"><?=$value['cat_name']?>&nbsp;&nbsp;<span class="iconfont icon-iconjiantouyou rel_top1"></span></a>
											</dt>
											...
											<dd>
                                                                                            <?php if(!empty($value['sub'])){
                                                                                                ...
                                                                                                ?>
                                                                                            <a href="index.php?ctl=Goods_Goods&met=goodslist&debug=1&cat_id=<?=$sub_value['cat_id']?>"><?=$sub_value['cat_name']?></a>
                                                                                             <?php } } ?>
											</dd></dl>
                                                                                                   <?php } ?>
                                                                        ...
                                                                        <ul class="d1ul clearfix">
                                                                            <?php if(!empty($catone['brand'])){
                                                                                    foreach ($catone['brand'] as $brand_key => $brand_value) {
                                                                                        ...
                                                                                        ?>
                                                                            <li class="">
                                                                                <a href="index.php?ctl=Goods_Goods&met=goodslist&debug=1&brand=<?=$brand_value['brand_id']?>"><img src="<?=$brand_value['brand_pic']?>">
