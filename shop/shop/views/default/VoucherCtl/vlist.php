...
<div class="bbc-breadcrumb-layout">
   <div class="bbc-breadcrumb wrapper"><i class="icon-home"></i> <span><a href="<?=Yf_Registry::get('url')?>"><?=_('首页')?></a></span><span class="arrow"><i class="iconfont icon-iconjiantouyou"></i></span> <span><a href="<?=Yf_Registry::get('url')?>?ctl=Points&met=index"><?=_('积分中心')?></a></span><span class="arrow"><i class="iconfont icon-iconjiantouyou"></i></span> <span><a href="<?=Yf_Registry::get('url')?>?ctl=Points&met=index"><?=_('兑换礼品列表')?></a></span> </div>
</div>
        ...
        <div class="bbc-category">
            ...
            <dl class="searchbox">
                ...
                <ul>
                    ...
                    <li class="<?=(request_string('orderby')=='pointsdesc' || request_string('orderby')=='pointsasc')?'hova':''?>" onclick='list(<?=request_string('orderby')=='pointsdesc'?'"pointsasc"':'"pointsdesc"'?>)' op_type="search_orderby"><?=_('积分值')?>
                        <em class="display_arrow">
        ...
        <ul class="ncp-voucher-list">
            ...
            <li>
                <div class="ncp-voucher" data-id="<?=$value['voucher_t_id']?>">
                    ...
                    <div class="point">
                        <p class="required"><?=_('需')?><em><?=$value['voucher_t_points']?></em><?=_('积分')?></p>
