  ...
  <div class="clearfix">
     ...
     <div id="nav" class="bbc-nav">
      <ul>
          ...
          <li class="active9"><a href="index.php?ctl=Shop&id=<?=$shop_id?>"><span>店铺首页<i></i></span></a></li>
  ...
  <div class="t_goods_bot clearfix">
    <div class="t_goods_bot_left">
      <div class="goods_classify">
        ...
        <p class="classify_ser">
          <input  name="searchGoodsList" type="text" placeholder="搜索店内商品">
    ...
    <div id="hot_sales_list" class="ncs-top-panel">
          ...
          <dl>
            ...
            <dd class="selled pngFix">售出：<strong><?=$value['common_salenum']?></strong>笔</dd>
          </dl>
        </li>
                <?php } }?>
    ...
    <div id="hot_collect_list" class="ncs-top-panel hide">
          ...
          <dl>
            ...
            <dd class="price pngFix bbc_color"><?=format_money($value['common_price']) ?></dd>
            <dd class="selled pngFix">收藏人气：<strong><?=$value['common_collect']?></strong></dd>
          </dl>
        </li>
                <?php } }?>
        ...
        <div class="current_hot">
                    ...
                    foreach ($hot_groupbuy_data as $key_hot => $value_hot):
                        ...
                        <li>
                            ...
                            <div class="current_hot__look clearfix"><a
                                    href="./index.php?ctl=GroupBuy&met=detail&id=<?= $value_hot['groupbuy_id'] ?>">去看看</a>
                            </div>
                        </li>
                    <?php
                    endforeach;
            ...
            <div class="hot_all"><a href="./index.php?ctl=GroupBuy&met=groupBuyList" class="bbc_btns">全部热门团购</a></div>
        </div>
    </div>
          ...
          <ul>
            ...
            <li>
              <dl>
                ...
                <dd class="goods-info"><span class="priceSS bbc_color"><?=format_money($value['common_price']) ?></span> <span class="goods-sold">已售：<strong><?=$value['common_salenum']?></strong> 件</span></dd>
              </dl>
            </li>
              <?php }}?>
          </ul>
