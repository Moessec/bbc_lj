...
<div class="wrapper page">
    <div class="fixed-bar">
        <div class="item-title">
            ...
            <ul class="tab-base nc-row">
                ...
                <li><a class="current"><span>面额设置</span></a></li>
    ...
    <p class="warn_xiaoma"><span></span><em></em></p><div class="explanation" id="explanation">
        ...
        <ul>
            <li>管理员规定代金券面额，店铺发放代金券时面额从规定的面额中选择。</li>
        </ul>
    </div>
...
<script src="<?= Yf_Registry::get('base_url') ?>/shop_admin/static/default/js/controllers/promotion/voucher/price_list.js"></script>
