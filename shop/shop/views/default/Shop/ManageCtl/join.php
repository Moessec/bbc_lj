...
<div class="wrapper page">
  <div class="fixed-bar">
    <div class="item-title">
      <div class="subject">
        <h3>店铺管理</h3>
        <h5>店铺管理-店铺的审核续费及经营类目结算周期操作</h5>
      </div>
		  <ul class="tab-base nc-row">
		  <li><a href="<?= Yf_Registry::get('url') ?>?ctl=Shop_Manage&met=indexs" ><span>店铺设置</span></a></li>
		  <li><a class="current" href="<?= Yf_Registry::get('url') ?>?ctl=Shop_Manage&met=join" ><span>审核开店信息</span></a></li>
...
<script type="text/javascript" src="<?=$this->view->js?>/controllers/shop/join/shop_join_list.js" charset="utf-8"></script>
  <?php
