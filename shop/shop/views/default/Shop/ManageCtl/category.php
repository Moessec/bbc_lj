    ...
    <div class="fixed-bar">
        <div class="item-title">
            ...
            <ul class="tab-base nc-row">
                <li><a href="<?= Yf_Registry::get('url') ?>?ctl=Shop_Manage&met=indexs" ><span>商城设置</span></a></li>
		  <li><a href="<?= Yf_Registry::get('url') ?>?ctl=Shop_Manage&met=join" ><span>审核开店信息</span></a></li>
                  <li><a  href="<?= Yf_Registry::get('url') ?>?ctl=Shop_Manage&met=pay" ><span>审核店铺付款</span></a></li>
                  <li><a href="<?= Yf_Registry::get('url') ?>?ctl=Shop_Manage&met=reopen" ><span>续签申请</span></a></li>
                  <li><a href="<?= Yf_Registry::get('url') ?>?ctl=Shop_Manage&met=category" class="current" ><span>经营类目申请</span></a></li>
		...
		<div class="left">
                    <div id="assisting-category-select" class="ui-tab-select">
                        <ul class="ul-inline">
                                ...
                                <li>
                                  <span id="shop_class_bind_enable"></span>
                                </li>
...
<script type="text/javascript" src="<?=$this->view->js?>/controllers/shop/index/shop_category_list.js" charset="utf-8"></script>
