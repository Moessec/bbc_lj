        ...
        <div class="ncap-form-default">
            ...
            <dl class="row">
             ...
             <dl class="row">
                ...
                <dd class="opt">
                <div class="onoff">
                        <label for="shop_grade_function_id1" class="cb-enable <?=($value['shop_grade_function_id'] ? 'selected' : '')?> ">开启</label>
                        <label for="shop_grade_function_id0" class="cb-disable <?=(!$value['shop_grade_function_id'] ? 'selected' : '')?>">关闭</label>
             ...
             <dl class="row">
                ...
                <dd class="opt">
                    <input id="shop_grade_sort" name="shop_grade_sort" value="<?=$value["shop_grade_sort"]?>" class="ui-input w200" type="text"/>
                </dd>
