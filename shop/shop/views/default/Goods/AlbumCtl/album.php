...
?>
    ...
    <div class="page">
        <div class="fixed-bar">
            <div class="item-title">
                ...
                <ul class="tab-base nc-row">
                    <li><a class="current" href="javascript:void(0)"><span>图片管理</span></a></li>
                </ul>
            </div>
        </div>
        <!-- 操作说明 -->
        <p class="warn_xiaoma"><span></span><em></em></p><div class="explanation" id="explanation">
            ...
            <ul>
                <li>仅删除分组，不删除图片，组内图片将自动归入未分组</li>
            </ul>
            <!--<div class="fr">
    ...
    <script type="text/javascript" src="<?= $this->view->js ?>/controllers/goods/album_list.js" charset="utf-8"></script>
<?php
