...
?>
    ...
    <div class="w wrap clearfix">
        <div class="top-nav clearfix">
            <ul class="nav-items">
                <li class="seles"><a href="#"><?=_('全部商品分类');?></a></li>
                <li><a href="index.php?ctl=Goods_Brand" target="_blank"><?=_('全部品牌'); ?></a></li>
                <li><a href="index.php?ctl=Goods_Goods&met=goodslist" target="_blank"><?=_('全部商品'); ?></a></li>
            </ul>
        </div>
                            ...
                            foreach ($data as $key => $value)
                            {
                                ...
                                <div class="category-item m white-panel" data-idx="0">
                                    ...
                                    <div class="mc">
                                        <div class="item-hot clearfix" clstag="secondtype|keycount|allfenlei|spfl_1">
                                            ...
                                            { ?>
                                                <a title="<?= $value1['common_name']; ?>"
                                                   href="index.php?ctl=Goods_Goods&met=goods&gid=<?= $value1['goods_id']; ?>"
                                        ...
                                        <div class="item-info"><?=_('热卖爆品'); ?></div>
                ...
                <div class="current_hot">
                    ...
                    <ul>
                        <?php if (!empty($data_recommon_goods))
                        {
                            ...
                            {
                                ?>
                                <li><a href="<?= Yf_Registry::get('url') ?>?ctl=Goods_Goods&met=goods&gid=<?=($value_recommon['goods_id'])?>"><img src="<?= $value_recommon['common_image'] ?>"/><h5>
                    ...
                    <div class="hot_all"><a href="<?= Yf_Registry::get('url') ?>?ctl=GroupBuy&met=groupBuyList" class="bbc_bg"><?=_('全部热门团购'); ?></a></div>
                </div>
            </div>
        </div>
    </div>
