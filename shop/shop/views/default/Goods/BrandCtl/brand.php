    ...
    <div class="fixed-bar">
        <div class="item-title">
            ...
            <ul class="tab-base nc-row">
                <li><a href="index.php?ctl=Goods_Brand&met=brand" class="current">管理</a></li>
                <li><a href="index.php?ctl=Goods_Brand&met=brands">待审核</a></li>
            </ul>
        </div>
    </div>
...
<script type="text/javascript" src="<?=$this->view->js?>/controllers/goods/goods_brand.js" charset="utf-8"></script>
<?php
