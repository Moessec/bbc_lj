<li style="display:block">
    <div class=" Top">
		<p>
			<span style="color:red;"><?=_('注意：')?></span>
			<strong><?=_('购买的价格不可能是由于店铺往期促销活动引起的，详情库咨询卖家')?></strong>
		</p>
    </div>

    <table class="details_table">
        <tr>
            <td class="w200"><?=_('买家')?></td>
			<td class="w386"><?=_('宝贝名称')?></td>
			<td class="w100"><?=_('出价')?></td>
            <td class="w100"><?=_('购买数量')?></td>
            <td class="w200"><?=_('生成时间')?></td>
        </tr>
