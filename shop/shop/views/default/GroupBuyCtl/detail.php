    ...
    <div class="t_goods_detail">
        <div class="crumbs clearfix">
            <p>
                ...
                <a href="<?= Yf_Registry::get('url') ?>?ctl=GroupBuy&met=index"><?=_('团购中心')?></a><i class="iconfont icon-iconjiantouyou"></i>
            ...
            <div style="width: 935px;" class="ev_left2">
                <div class="ncg-main buy-now">
                    <div class="ncg-group sticky">
                        ...
                        <div class="ncg-item">
                            <div class="pic"><img src="<?=image_thumb($data['groupbuy_detail']['groupbuy_image'],480,360)?>" alt=""></div>
                            <div class="button bbc_bg">
                                <span class="bbc_color"><em><?=format_money($data['groupbuy_detail']['groupbuy_price'])?></em></span>
                                <a href="<?=Yf_Registry::get('url')?>?ctl=Goods_Goods&met=goods&gid=<?=$data['groupbuy_detail']['goods_id']?>" target="_blank">
...
<div class="t_goods_bot clearfix wrap">
    <div class="t_goods-left">
        <div class="current_hot current_hots">
            ...
            <div class="hot_all"><a class="bbc_btns" href="<?=Yf_Registry::get('url')?>?ctl=GroupBuy&met=index&typ=e"><?=_('全部热门团购')?></a></div>
        </div>
    </div>
    ...
    <div class="t_goods_bot_right t_goods_ct_right">
        ...
        <div class="das2 clearfix">
            <?php if (!empty($data_foot_recommon_goods))
            {
                ...
                {
                    ?>
                    <a href="<?= Yf_Registry::get('url') ?>?ctl=Goods_Goods&met=goods&gid=<?=($value_foot_recommon_goods['goods_id'])?>">
                        <div class="img_2">
