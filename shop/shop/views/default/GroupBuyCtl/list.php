...
<div class="wrap">
    <div class="crumbs clearfix">
        <p>
            ...
            <a href="<?=Yf_Registry::get('url')?>?ctl=GroupBuy&met=groupBuyList"><?=_('线上团')?></a>
    ...
    <div class="ncg-content">
        ...
        <div class="rightcont">
            ...
            <!-- 分类过滤列表 -->
                ...
                <dl>
                    <dt><?=_('状态')?>：</dt>
                    <dd class="<?=(request_string('state')!='underway' && request_string('state')!='history') ? 'hova' : ''?>"><a href="<?=Yf_Registry::get('url')?>?ctl=GroupBuy&met=groupBuyList"><?=_('正在进行')?></a></dd>
                    <dd class="<?=request_string('state')=='underway'?'hova':''?>"><a href="<?=Yf_Registry::get('url')?>?ctl=GroupBuy&met=groupBuyList&state=underway" ><?=_('即将开始')?></a></dd>
                    <dd class="<?=request_string('state')=='history'?'hova':''?>"><a href="<?=Yf_Registry::get('url')?>?ctl=GroupBuy&met=groupBuyList&state=history" ><?=_('已经结束')?></a></dd>
                </dl>
            ...
            <div class="group-list">
                ...
                ?>
                    <li class="online">
                        ...
                        <a title="<?=$groupbuy_goods['goods_name']?>" href="<?=Yf_Registry::get('url')?>?ctl=GroupBuy&met=detail&id=<?=$groupbuy_goods['groupbuy_id']?>" class="pic-thumb" target="_blank">
