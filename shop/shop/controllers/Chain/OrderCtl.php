...
class Chain_OrderCtl extends Chain_Controller
{
    ...
    public function processOrder()
    {
        ...
        if ($pickup_code == $order_goodsChainCode['chain_code_id']) {
            ...
            $order_goodsChainCodeModel->editGoodsChainCode($order_goodsChainCode['chain_code_id'], $code_row);
            ...
            $chain_goods = current($Chain_GoodsModel->getByWhere($cond_row));
            $chain_goods_id = $chain_goods['chain_goods_id'];
            $goods_stock['goods_stock'] = $chain_goods['goods_stock'] - $stock;
            $flag = $Chain_GoodsModel->editGoods($chain_goods_id, $goods_stock);
