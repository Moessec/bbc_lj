...
class Seller_Promotion_VoucherCtl extends Seller_Controller
{
	...
	public function addCombo()
	{
		...
		if($month > 0)
		{
			...
			$field_row['cost_desc']   = _('店铺购买代金券活动消费');
