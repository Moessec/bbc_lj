	...
	public function replyConsult()
	{
		...
		if ($consult['shop_id'] == Perm::$shopId)
		{
			...
			if ($flag)
			{
				...
				$message->sendMessage('Commodity advisory reply reminder', $consult['user_id'], $consult['user_account'], $order_id = NULL, $shop_name = NULL, 0, 1, $end_time = Null,$common_id=NULL,$goods_id=NULL,$des=NULL, $start_time = Null,$consult['goods_name']);
			}
			else
			{
				$status = 250;
