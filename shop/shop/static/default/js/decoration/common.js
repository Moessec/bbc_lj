...
(function($) {
    $.fn.nc_show_dialog = function(options) {
        ...
        var init_dialog = function(title) {
            ...
            that.find('.dialog_body').prepend('<h3 class="dialog_head" style="cursor: move;"><span class="dialog_title"><span class="dialog_title_icon">'+settings.title+'</span></span><span class="dialog_close_button">×</span></h3>');
