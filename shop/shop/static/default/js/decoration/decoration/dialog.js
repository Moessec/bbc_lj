...
/*common2.2.js*/
DIALOGIMGDIR  = SITE_URL+"/"+'resource/js/dialog/images/dialog';
...
function showDialog(msg, mode, t, func, cover, funccancel, leftmsg, confirmtxt, canceltxt, closetime, locationtime) {
	...
	s += '</span><span class="dialog_close_button" id="fwin_dialog_close" onclick="hideMenu(\'' + menuid + '\', \'dialog\')" title="关闭">×</span></h3>';
	if(mode == 'info') {
		s += msg ? msg : '';
	} else {
