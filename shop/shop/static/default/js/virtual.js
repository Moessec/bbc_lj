		...
		$(".voucher_list").each(function(){
			...
			if(flag)
			{
				...
				$.ajax({
					...
					data:{buyer_phone:buyer_phone,goods_id:goods_id,goods_num:goods_num,remarks:remarks,increase_goods_id:increase_goods_id,voucher_id:voucher_id,pay_way_id:1},
					dataType: "json",
