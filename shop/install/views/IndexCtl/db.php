...
<p id="logo"><a href="https://cn.yf_.org/" tabindex="-1">BBCBuilder</a></p>
<?php
$msg = '';
...
<form method="post" action="./index.php?met=initDbConfig&language=zh_CN">
	<table class="form-table">
		...
		<tr>
			...
			<td><input name="prefix" id="prefix" type="text" value="<?php echo defined('TABEL_PREFIX') ? TABEL_PREFIX : 'yf_';?>" size="25" /></td>
			<td>如果您希望在同一个数据库安装多个BBCBuilder，请修改前缀。</td>
		</tr>
	</table>
