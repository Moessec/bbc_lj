...
<div class="wrapper page">
    <div class="fixed-bar">
        <div class="item-title">
            ...
            <ul class="tab-base nc-row">
				<li><a href="<?= Yf_Registry::get('url') ?>?ctl=Licence&met=index&typ=e"><span>软件授权</span></a></li>
                <li><a class="current"  ><span>检测记录</span></a></li>
            </ul>
        </div>
    </div>
    ...
    <p class="warn_xiaoma"><span></span><em></em></p><div class="explanation" id="explanation">
        ...
        <ul>
            <li>检测记录, 外网ip及域名使用者的未验证通过的记录</li>
        </ul>
    </div>
...
<script type="text/javascript" src="<?=$this->view->js?>/controllers/licence_log_list.js" charset="utf-8"></script>
<?php
