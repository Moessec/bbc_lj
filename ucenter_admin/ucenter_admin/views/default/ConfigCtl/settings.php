    ...
    <div class="fixed-bar">
        <div class="item-title">
            ...
            <ul class="tab-base nc-row">
                ...
                <li><a class="current" href="<?= Yf_Registry::get('url') ?>?ctl=Config&met=settings&typ=e&config_type%5B%5D=site"><span>站点Logo</span></a></li>
    ...
    <form method="post" enctype="multipart/form-data" id="site-config-form" name="form">
        ...
        <div class="ncap-form-default">
            ...
            <dl class="row">
                ...
                <dd class="opt">
                    <img id="site_logo_image" name="site[site_logo]" alt="选择图片" src="<?=($data['site_logo']['config_value'])?>" width="240px" height="60px" />
...
<script>
    ...
    $(function(){
        ...
        $('#site_logo_upload, #seller_logo_upload, #buyer_logo_upload').on('click', function () {
