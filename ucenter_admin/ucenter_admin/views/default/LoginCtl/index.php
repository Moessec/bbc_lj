	...
	<div class="center-content">
		...
		<div class="login-area">
			<div class="top">
				...
				<h2 class="shadow">UCenter</h2>
				<!-- <h6>请立即注册 或是 找回密码？</h6>-->
			</div>
			<div class="box">
				<form method="post" action="./index.php?ctl=Login&met=login">
								<span>
								...
								<span>
									<input type="submit" value="登录" class="input-button" name="" style="margin-bottom:10px;">
								</span>
				</form>
				<!-- <span>
