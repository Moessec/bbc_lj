...
<div class="wrapper page">
    ...
    <p class="warn_xiaoma"><span></span><em></em></p><div class="explanation" id="explanation">
        <div class="title" id="checkZoom"><i class="iconfont icon-lamp"></i>
            ...
            <span id="explanationZoom" title="收起提示"></span><em class="close_warn">X</em><em class="close_warn">X</em></div>
        <ul>
            <li>实现不同的用户拥有不同的角色，不同的角色拥有不同的权限</li>
        </ul>
    </div>
    
    <div class="mod-toolbar-top" >
       <div class="fr"><a href="./index.php?ctl=Rights_Group&met=index" class="ui-btn ui-btn-sp mrb" id="btn-add">权限组管理</a></div>
