    	...
    	<form id="manage-form" action="">
    		...
    		<ul class="mod-form-rows base-form cf" id="base-form">
    			...
    			<li class="row-item odd">
    				...
    				<div class="ctn-wrap"><input type="text" value="http://t2.ucenter.yuanfeng021.com/index.php" class="ui-input" name="ucenter_url" id="ucenter_url"></div>
    			</li>

    			<li class="row-item">
    				<div class="label-wrap"><label for="paycenter_url">支付中心:</label></div>
    				<div class="ctn-wrap"><input type="text" value="http://t2.paycenter.yuanfeng021.com/index.php" class="ui-input" name="paycenter_url" id="paycenter_url"></div>
    			</li>
				<?php
				endif;
				?>
