...
<div class="manage-wrapper">
     <div id="manage-wrap" class="manage-wrap">
    	...
    	<input type="hidden" value="<?=Yf_Registry::get('erp_app_id')?>" class="ui-input" name="request_app_id" id="request_app_id">
...
<script src="./ucenter_admin/static/default/js/controllers/user/base/erp_accountmanage.js"></script>
<?php
