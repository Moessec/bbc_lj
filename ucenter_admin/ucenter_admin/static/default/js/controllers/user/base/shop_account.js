    ...
    function b() {
        ...
        j.gridReg('grid', l),
            ...
            $('#grid').jqGrid({
                ...
                url: SITE_URL + '?ctl=User_Base&met=getShopUserList&typ=json&cloud_type=' + cloud_type,
        ...
        h = {
            operate: function (a, b) {
                if(a=='edit')
                {
                    $.dialog({
                        title: '编辑',
                        content: 'url:'+SITE_URL + "?ctl=User_Base&met=shopAccountManage&typ=e&id=" + b + '&cloud_type=' + cloud_type,
                        width: 700,
                        height: 400,
                ...
                if(a=='add')
                {
                    $.dialog({
                        title: '新增',
                        content: 'url:'+SITE_URL + "?ctl=User_Base&met=shopAccountManage&typ=e" + '&cloud_type=' + cloud_type,
                        width: 700,
                        height: 400,
