$(function() {
    ...
    var handle = {
        ...
        operate: function (oper, row_id)
        {
            ...
            {
                var title = sprintf(_('修改 [%s]'), $("#grid").data('gridData')[row_id]['licence_id']);
                var data = {
                    oper: oper,
                    rowId: row_id,
    ...
    function initGrid() {
        ...
        var colModel = [{
            ...
            "name": "licence_effective_startdate",
            "index": "licence_effective_startdate",
            "label": "生效日期",
            "classes": "ui-ellipsis",
            "align": "center",
            "title": false,
            ...
            "name": "licence_effective_enddate",
            "index": "licence_effective_enddate",
            "label": "失效日期",
            "classes": "ui-ellipsis",
            "align": "center",
            "title": false,
        ...
        $('#grid').jqGrid({
            url: SITE_URL + '?ctl=Licence&met=lists&typ=json',
            datatype: 'json',
            autowidth: true,
            shrinkToFit: true,
            forceFit: false,
            ...
            loadComplete: function(response) {
                if (response && response.status == 200) {
                    ...
                    for (var i = 0; i < data.items.length; i++) {
                        ...
                        item['id'] = item.licence_id;
                        gridData[item.licence_id] = item;
                    }
