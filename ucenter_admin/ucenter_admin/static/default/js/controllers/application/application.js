...
function initGrid()
{
    ...
    var t = ["操作", "服务ID", "服务名称", "服务类型", /*"顺序号",*/ "服务密钥", "服务 IP 列表", "服务网址", "是否启用"/*,"网址补给","检查订单是否存在的url地址","图片地址","域名列表","返回字段"*/];
    e = [{
        name: "operate",
        width: 60,
        //fixed: !0,
        ...
        {name: "app_name", index: "app_name", width: 100, align: "center",},
        {name: "app_type", index: "app_type", width: 100, align: "center",},
        //{name: "app_seq", index: "app_seq", width: 100},
        {name: "app_key", index: "app_key", width: 400, align: "left",},
        {name: "app_ip_list", index: "app_ip_list", width: 220, align: "center",},
    ...
    /*{name: "app_url_recharge", index: "app_url_recharge",  width: 100},
     {name: "app_url_order", index: "app_url_order",  width: 100},
     {name: "app_logo", index: "app_logo", width: 100},
     {name: "app_hosts", index: "app_hosts",width: 100},
     {name: "return_fields", index: "return_fields",width: 100}*/
