...
<div class="wrapper page">
    <div class="fixed-bar">
        <div class="item-title">
            ...
            <ul class="tab-base nc-row">
                ...
                <li><a class="current"><span>主题设置</span></a></li>
    ...
    <script src="<?= Yf_Registry::get('base_url') ?>/shop_admin/static/default/js/controllers/trade/complain/subject_list.js"></script>
<?php
