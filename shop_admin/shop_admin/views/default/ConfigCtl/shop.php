        ...
        <div class="ncap-form-default">
            ...
            <dl class="row">
                ...
                <dd class="opt">
                    ...
                    <img id="setting_buyer_image" name="setting[setting_buyer_logo]" alt="选择图片" src="<?=($data['setting_buyer_logo']['config_value'])?>" width="160px" height="60px" />
            ...
            <dl class="row">
                ...
                <dd class="opt" style="width: 30%;">
                    ...
                    <img id="setting_seller_image" name="setting[setting_seller_logo]" alt="选择图片" src="<?=($data['setting_seller_logo']['config_value'])?>" width="150px" height="40px" />
