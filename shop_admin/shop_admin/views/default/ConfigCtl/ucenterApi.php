    ...
    <div class="fixed-bar">
        <div class="item-title">
            ...
            <ul class="tab-base nc-row">
                ...
                <li><a class="current"  href="<?= Yf_Registry::get('url') ?>?ctl=Config&met=ucenterApi&config_type%5B%5D=api"><span>UCenter API设置</span></a></li>
                <li><a href="<?= Yf_Registry::get('url') ?>?ctl=Config&met=paycenterApi&config_type%5B%5D=api"><span>PayCenter API设置</span></a></li>
                <li><a href="<?= Yf_Registry::get('url') ?>?ctl=Config&met=imApi&config_type%5B%5D=api"><span>IM API设置</span></a></li>
            </ul>
        </div>
    </div>
    <?php
        ...
        <div class="ncap-form-default">
            ...
            <dl class="row">
                ...
                <dd class="opt">
                    ...
                    <p class="notic">请填写商城系统与Ucenter通讯的Key值,此外的值要与Ucenter后台应用的值保持一致</p>
                </dd>
            </dl>
