...
<div class="wrapper page">
    ...
    <div class="fixed-bar">
        <div class="item-title">
            ...
            <ul class="tab-base nc-row">
                <li><a class="current"><span>首页</span></a></li>
            </ul>
        </div>
    </div>
    ...
    <p class="warn_xiaoma"><span></span><em></em></p><div class="explanation" id="explanation">
        ...
        <ul>
            ...
            <li>新增加的版块内容默认为“禁用”状态，编辑内容并“启用”该块后将在手机端即时显示。</li>
        </ul>
    </div>
                ...
                case 'goods' :
                    ...
                    html = '<div nctype="special_item" class="special-item goods '+ (item_data.mb_tpl_layout_enable == 1 ? 'usable' : 'unusable') +'" data-item-id="' + item_data.mb_tpl_layout_id + '">' +
                                ...
                                '<div id="item_edit_content">' +
                                    '<style type="text/css">' +
                                        '.mb-item-edit-content { background: #EFFAFE url(http://b2b2c.shopnctest.com/tesa/shopnc/templates/default/images/cms_edit_bg_line.png) repeat-y scroll 0 0; }' +
                                    '</style>' +
...
<script src="http://b2b2c.shopnctest.com/tesa/data/resource/js/jquery.ajaxContent.pack.js" type="text/javascript"></script>
<script type="text/javascript">
    $(document).ready(function(){
        $('#btn_mb_special_goods_search').on('click', function() {
            var url = 'http://b2b2c.shopnctest.com/tesa/shopnc/modules/mobile/index.php?act=mb_special&op=goods_list';
