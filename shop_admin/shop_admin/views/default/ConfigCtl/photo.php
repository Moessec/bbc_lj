...
<div class="wrapper page">
    ...
    <p class="warn_xiaoma"><span></span><em></em></p><div class="explanation" id="explanation">
        ...
        <ul>
            <li>网站全局图片上传设置，商城及其他模块在上传图片规则按此处设置进行操作</li>
        </ul>
    </div>
...
$(function(){
	...
	//图片上传
      /*   photo_goods_logo = new UploadImage({
            thumbnailWidth: 300,
            thumbnailHeight: 300,
        ...
        photo_shop_upload = new UploadImage({
            thumbnailWidth: 200,
            thumbnailHeight: 60,
        ...
        photo_head_upload = new UploadImage({
            thumbnailWidth: 180,
            thumbnailHeight: 80,
		 ...
		 photo_user_upload = new UploadImage({
            thumbnailWidth: 120,
            thumbnailHeight: 120,
