    ...
    <div class="fixed-bar">
        <div class="item-title">
		  ...
		  <li><a href="<?= Yf_Registry::get('url') ?>?ctl=Shop_Manage&met=join" ><span>审核开店信息</span></a></li>
                  ...
                  <li><a class="current" href="<?= Yf_Registry::get('url') ?>?ctl=Shop_Manage&met=reopen" ><span>续签申请</span></a></li>
...
<script type="text/javascript" src="<?=$this->view->js?>/controllers/shop/index/shop_reopen_list.js" charset="utf-8"></script>
