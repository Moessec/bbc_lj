    ...
    <div class="fixed-bar">
        <div class="item-title">
		  ...
		  <li><a href="<?= Yf_Registry::get('url') ?>?ctl=Shop_Manage&met=join" ><span>审核开店信息</span></a></li>
                  ...
                  <li><a class="current" ><span>结算周期设置</span></a></li>
            </ul>
        </div>
       </div>
          <!-- 操作说明 -->
...
<script type="text/javascript" src="<?=$this->view->js?>/controllers/shop/index/shop_settlement_list.js" charset="utf-8"></script>
