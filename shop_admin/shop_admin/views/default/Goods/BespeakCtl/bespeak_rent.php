    ...
    <div class="fixed-bar">
        <div class="item-title">
            ...
            <ul class="tab-base nc-row">
                <li><a href="<?= Yf_Registry::get('url') ?>?ctl=Goods_Bespeak&met=bespeak" class=""><span>报修管理</span></a></li>
                <li><a href="<?= Yf_Registry::get('url') ?>?ctl=Goods_Bespeak&met=bespeak_act" class=""><span>活动预约</span></a></li>
                <li><a href="<?= Yf_Registry::get('url') ?>?ctl=Goods_Bespeak&met=bespeak_rent" class="current"><span>租赁管理</span></a></li>
            </ul>
        </div>
    </div>
...
<script type="text/javascript" src="<?=$this->view->js?>/controllers/goods/bespeak_rent.js" charset="utf-8"></script>
<?php
