	...
	<div class="js-main-region">
  	...
  	<div class="modal-body" id="image-list">
		    ...
		    <div class="attachment-list-region js-attachment-list-region">
	            ...
	            <a href="javascript:;" class="ui-btn ui-btn-success js-show-upload-view" style="position: absolute; left: 180px; bottom: 16px;">上传图片<i class="iconfont icon-tupianshangchuan"></i></a>
            </div>
