...
var THISPAGE = {
    ...
    loadGrid: function(){
        ...
        var colModel = [
            ...
            {name:'user_name', label:'店主账号',  width:250, align:"center"},
            {name:'shop_name', label:'店铺名称', width:250,align:'left'},
            {name:'shop_status_cha', label:'当前状态',  width:100, align:"center"},
            {name:'shop_all_class_cha', label:'是否绑定所有类目',  width:200, align:"center"},
