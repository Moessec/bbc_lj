...
var THISPAGE = {
    ...
    loadGrid: function(){
        ...
        var colModel = [
            ...
            {name:'shop_create_time', label:'开店时长',  width:100, align:"center"},
            {name:'shop_end_time', label:'到期时间',  width:100, align:"center"},
        ...
        $("#grid").jqGrid({
            url: SITE_URL + "?ctl=Shop_Manage&met=shopPay&typ=json",
    ...
    if(row.shop_payment == 1){
        var html_con = '<div class="operating" data-id="' + row.shop_id + '"><span class="ui-icon ui-icon-search" title="查看"></span><span class="ui-icon ui-icon-pencil" title="审核"></span></div>';
    }else{
        var html_con = '<div class="operating" data-id="' + row.shop_id + '"><span class="ui-icon ui-icon-search" title="查看"></span><span class="ui-icon ui-icon-pencil ui-icon-disabled" data-dis="1" title="审核"></span></div>';
    }
       return html_con;
};
...
var handle = {
    ...
    status: function (t)
    {
        $.dialog.confirm("审核通过店铺开启", function ()
        {
            Public.ajaxPost(SITE_URL + "?ctl=Shop_Manage&met=editShopStatus&typ=json", {shop_id: t}, function (e)
            {
                if (e && 200 == e.status)
                {
                    ...
                    location.href= SITE_URL + "?ctl=Shop_Manage&met=indexs"; 
                }
                else
                {
