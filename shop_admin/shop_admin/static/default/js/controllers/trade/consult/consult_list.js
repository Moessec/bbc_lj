	...
	var THISPAGE = {
		...
		loadGrid: function(){
			...
			var colModel = [
				...
				{name:'user_account', label:'咨询人', width:150, align:"center"},
				{name:'consult_question', label:'咨询内容',  width:300, align:"center"},
				{name:'goods_name', label:'咨询商品',  width:600, align:"left"},
				{name:'question_time', label:'咨询时间',  width:140, align:"center",sortable:true},
				{name:'shop_name', label:'商家名称',  width:150, align:"center"},
			];
