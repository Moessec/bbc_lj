...
var queryConditions = {"otyp":urlParam.otyp},
	...
	var THISPAGE = {
		...
		loadGrid: function(){
			...
			var colModel = [
				{name:'operating', label:'操作', fixed:true, width:30, formatter:operFmatter, align:"center"},
				{name:'user_account', label:'举报人', width:150, align:"center"},
				{name:'report_type_name', label:'举报类型',  width:300, align:"center"},
