...
var THISPAGE = {
    ...
    loadGrid: function ()
    {
        ...
        var colModel = [
            ...
            {name: 'user_account_accuser', label: '投诉人', width: 150, align: "center"},
            {name: 'complain_content', label: '投诉内容', width: 357, align: "left"},
            {
                name: 'complain_image',
                label: '投诉图片',
                width: 225,
            ...
            {name: 'user_id_accuser', label: '投诉人ID', width: 120, align: "center"},
            {name: 'user_id_accused', label: '商家ID', width: 120, align: "center"}
        ];
