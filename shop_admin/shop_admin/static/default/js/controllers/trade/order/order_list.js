	...
	var THISPAGE = {
		...
		loadGrid: function(){
			...
			var colModel = [
				{name:'operating', label:'操作', width:150, fixed:true, formatter:operFmatter, align:"center"},
				...
				{name:'order_refund_amount', label:'退款金额(元)', width:130,align:'center'},
				{name:'order_finished_time', label:'订单完成时间', width:150,align:"center"},
				{name:'order_buyer_evaluation_status', label:'是否评价',  width:120, align:"center", formatter: evalFmatter},
				{name:'shop_id', label:'店铺ID',  width:120, align:"center"},
				{name:'shop_name', label:'店铺名称',  width:120, align:"center"},
				{name:'buyer_user_id', label:'买家ID',  width:120, align:"center"},
				{name:'buyer_user_name', label:'买家账号', width:120, align:"center"}
			];
