...
function initGrid()
{
    var t = ["操作", "评价人", "描述相符", "服务态度", "发货速度", "被评商家", "评价时间", "订单编号","评价人id", "商家id"], e = [{
        ...
        {name: "evaluation_desccredit", index: "evaluation_desccredit", width: 200, align:"center"},
        {name: "evaluation_servicecredit", index: "evaluation_servicecredit", width:150, align:"center"},
        {name: "evaluation_deliverycredit",index: "evaluation_deliverycredit", width:150, align:"center"},
