...
function initGrid()
{
    var t = ["操作", "排序", "标题", "链接","显示位置", "新窗口打开", "是否启用"], e = [{
        ...
        {name: "nav_title", index: "nav_title", width: 100,align:"center"},
        {name: "nav_url", index: "nav_url", width: 450},
        {name: "nav_location_name", index: "nav_location_name",align: "center", width: 80},
        {name: "nav_new_open_name", index: "nav_new_open_name",align: "center", width:100},
        {name: "nav_active_name", index: "nav_active_name", align: "center", width: 50}
    ];
