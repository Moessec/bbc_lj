...
var THISPAGE = {
    ...
    loadGrid: function(){
        ...
        var colModel = [
            ...
            {name:'discount_start_time', label:'开始时间',  width:130, align:"center"},
            {name:'discount_end_time', label:'结束时间',  width:130, align:"center"},
            {name:'discount_lower_limit', label:'购买下限',  width:60, align:"center"},
            {name:'discount_state_label', label:'状态',  width:50, align:"center"}
        ];
