...
var THISPAGE = {
    ...
    loadGrid: function(){
        ...
        var colModel = [
            ...
            {name:'increase_start_time', label:'开始时间',  width:130, align:"center"},
            {name:'increase_end_time', label:'结束时间',  width:130, align:"center"},
            {name:'increase_state_label', label:'状态',  width:80, align:"center"},
        ];
