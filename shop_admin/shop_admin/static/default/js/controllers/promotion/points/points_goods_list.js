...
var THISPAGE = {
    ...
    loadGrid: function(){
		...
		[
            ...
            {name:'points_goods_name', label:'礼品名称', width:300, align:"left"},
            {name:'points_goods_image', label:'礼品图片',  width:60, align:"center",formatter:online_imgFmt,classes:"points_goods_image"},
            {name:'points_goods_points', label:'兑换积分', width:80,align:'center'},
            {name:'points_goods_price', label:'礼品原价', width:80, align:"center"},
            {name:'points_goods_storage', label:'库存', width:60,align:"center"},
            {name:'points_goods_view', label:'浏览',  width:60, align:"center"},
            {name:'points_goods_salenum', label:'售出',  width:60, align:"center"},
            {name:'points_goods_shelves_label', label:'上架',  width:60, align:"center"},
            {name:'points_goods_recommend_label', label:'推荐',  width:60, align:"center"}
        ];
