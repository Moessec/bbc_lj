...
var THISPAGE = {
    ...
    loadGrid: function(){
		...
		[
            ...
            {name:'points_order_rid', label:'兑换单号', width:150, align:"center"},
            {name:'points_buyername', label:'会员名称',  width:150, align:"center"},
            {name:'points_allpoints', label:'兑换积分', width:100,align:'center'},
            {name:'points_addtime', label:'兑换时间', width:130, align:"center"},
            {name:'points_orderstate_label', label:'状态', width:60,align:"center"}
        ];
