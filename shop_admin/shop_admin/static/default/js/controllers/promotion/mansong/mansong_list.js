...
var THISPAGE = {
    ...
    loadGrid: function(){
        ...
        var colModel = [
            ...
            {name:'mansong_start_time', label:'开始时间',  width:130, align:"center"},
            {name:'mansong_end_time', label:'结束时间',  width:130, align:"center"},
            {name:'mansong_state_label', label:'状态',  width:50, align:"center"}
        ];
