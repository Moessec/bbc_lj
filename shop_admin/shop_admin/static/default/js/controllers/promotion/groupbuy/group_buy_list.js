...
var THISPAGE = {
    ...
    loadGrid: function(){
        ...
        var colModel = [
            ...
            {name:'groupbuy_type_label', label:'团购类型', width:60, align:"center"},
            {name:'groupbuy_name', label:'团购名称', width:200, align:"center", formatter:nameFmatter},
            {name:'goods_name', label:'商品名称',  width:300, align:"left"},
            {name:'shop_name', label:'店铺名称',  width:150, align:"center","formatter": handle.linkShopFormatter},
            {name:'groupbuy_image', label:'团购图片',  width:60, align:"center",formatter:online_imgFmt,classes:"groupbuy_image"},
            {name:'groupbuy_starttime', label:'开始时间',  width:130, align:"center"},
            {name:'groupbuy_endtime', label:'结束时间',  width:130, align:"center"},
            {name:'groupbuy_views', label:'浏览数',  width:50, align:"center"},
            {name:'groupbuy_buy_quantity', label:'已购买',  width:50, align:"center"},
            {name:'groupbuy_recommend_label', label:'推荐',  width:80, align:"center"},
            {name:'groupbuy_state_label', label:'团购状态',  width:70, align:"center"}
        ];
        ...
        function operFmatter (val, opt, row) {
            var html_con = '<div class="operating" data-id="' + row.groupbuy_id + '"><span class="ui-icon ui-icon-trash" title="删除"></span><a href="'+SHOP_URL+'?ctl=GroupBuy&met=detail&id=' + row.groupbuy_id+'" target="_blank"><span class="ui-icon ui-icon-search" title="查看活动"></span></a><span class="ui-icon ui-icon-pencil" title="设置"></span></div>';
            return html_con;
        };
