...
function initGrid()
{
    var t = [ "店铺名称", "开始时间","结束时间"],
        e = [
            ...
            {name: "shop_name", index: "shop_name", align: "left",width: 200,"formatter":linkShopFormatter},
            {name: "combo_starttime", index: "combo_starttime",align: "center",width: 150},
            {name: "combo_endtime", index: "combo_endtime",align: "center",width: 150}
        ];

    $("#grid").jqGrid({
        url: SITE_URL + '?ctl=Promotion_GroupBuy&met=getGroupBuyQuotaList&typ=json',
        datatype: "json",
