    ...
    var THISPAGE = {
        ...
        loadGrid: function(){
            ...
            var colModel = [
                ...
                {name:'voucher_t_title', label:'代金券名称',"classes": "ui-ellipsis", width:120, align:"center"},
                ...
                {name:'voucher_t_price', label:'面额',"classes": "ui-ellipsis", width:60,align:'center'},
                {name:'voucher_t_limit', label:'消费金额',"classes": "ui-ellipsis", width:60, align:"center"},
                /*{name:'voucher_t_price', label:'会员级别', width:200,align:"center"},*/
                {name:'voucher_t_add_date', label:'最后修改时间',"classes": "ui-ellipsis",  width:130, align:"center"},
                {name:'voucher_t_start_date', label:'开始时间',"classes": "ui-ellipsis",  width:130, align:"center"},
                {name:'voucher_t_end_date', label:'结束时间',"classes": "ui-ellipsis",  width:130, align:"center"},
                {name:'voucher_t_access_method_label', label:'领取方式',"classes": "ui-ellipsis",  width:90, align:"center"},
                {name:'voucher_t_state_label', label:'状态',"classes": "ui-ellipsis",  width:80, align:"center"},
                {name:'voucher_t_recommend', label:'推荐',"classes": "ui-ellipsis",  width:80, align:"center","formatter": handle.statusFormatter}
            ];
            $("#grid").jqGrid({
