...
var THISPAGE = {
    ...
    loadGrid: function(){
        ...
        var colModel = [
            ...
            {name:'user_tag_id', label:'标签ID', width:50, align:"center"},
         
            {name:'user_tag_name', label:'标签名称', width:150,align:'center'},
            {name:'user_tag_sort', label:'标签排序', width:80,align:'center'},
            {name:'user_tag_image', label:'标签图片', width:120, align:"center","formatter": handle.imgFmt ,classes:'img_flied'},
            {name:'user_tag_content', label:'标签描述', width:450, align:"left"},
            {name:'user_tag_recommend', label:'是否推荐', width:50, align:"center"},
