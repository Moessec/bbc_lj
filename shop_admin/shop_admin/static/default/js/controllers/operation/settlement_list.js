...
var THISPAGE = {
    ...
    loadGrid: function(){
		...
		{name: "os_id", label: "账单编号", align: "center",width: 96,sortable:true},
		{name: "os_order_amount", label: "订单金额(含运费)", align: "center",width: 80,sortable:true},
		{name: "os_shipping_amount", label: "运费", align: "center",width: 80,sortable:true},
		{name: "os_commis_amount", label: "收取佣金", align: "center",width: 80,sortable:true},
		{name: "os_order_return_amount", label: "退单金额", align: "center",width: 80,sortable:true},
		{name: "os_commis_return_amount", label: "退还佣金", align: "center",width: 80,sortable:true},
		{name: "os_shop_cost_amount", label: "店铺费用", align: "center",width: 80,sortable:true},
		{name: "os_amount", label: "本期应结", align: "center",width: 80,sortable:true},
		{name: "os_datetime", label: "出账日期", align: "center",width: 140,sortable:true},
		{name: "os_state_text", label: "账单状态", align: "center",width: 80,sortable:false},
		{name: "shop_name", label: "商家名称", align: "center",width: 150,sortable:false},
		{name: "os_start_date", label: "开始日期", align: "center",width: 140,sortable:true},
		{name: "os_end_date", label: "结束日期", align: "center",width: 140,sortable:true},
        ];
