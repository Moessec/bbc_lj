...
var THISPAGE = {
    init: function(data){
        ...
        this.mod_PageConfig = Public.mod_PageConfig.init('contract_cash_log_list');//页面配置初始化
        this.initDom();
        this.loadGrid();            
        this.addEvent();
    },
    ...
    loadGrid: function(){
		...
		{name: "contract_cash", label: "金额(元)", align: "center",width: 150,sortable:true},
		...
		{name: "contract_log_desc", label: "描述", align: "center",width: 250,sortable:false}
        ];
        this.mod_PageConfig.gridReg('grid', colModel);
        colModel = this.mod_PageConfig.conf.grids['grid'].colModel;
        $("#grid").jqGrid({
            url:SITE_URL + "?ctl=Operation_Contract&met=getLogList&logtype=1&typ=json",
