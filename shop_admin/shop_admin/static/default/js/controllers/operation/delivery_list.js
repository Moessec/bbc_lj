...
var THISPAGE = {
    ...
    loadGrid: function(){
		...
		{name: "delivery_address", label: "详细地址", align: "center",width: 250,sortable:false},
		{name: "delivery_state_text", label: "状态", align: "center",width: 40,sortable:false},
		{name: "delivery_apply_date", label: "申请时间", align: "center",width: 140,sortable:true},
        ];
