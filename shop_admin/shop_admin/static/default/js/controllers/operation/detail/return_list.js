...
var THISPAGE = {
    ...
    loadGrid: function(){
		...
		{name: "return_finish_time", label: "退款日期", align: "center",width: 140,sortable:true},
    ...
    addEvent: function(){
        ...
        $("#btn-excel").click(function ()
        {
            ...
            window.open(SHOP_URL + "?ctl=Api_Operation_Settlement&met=getReturnExcel&debug=1"+query);
        });
