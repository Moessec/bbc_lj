...
function initGrid()
{
    ...
    var t = ["操作", "相册ID", "相册名称", "店铺ID", "店铺名称", "图片数量"], e = [{
        ...
        {name: "album_id", index: "album_id", width:150,  align: "center"},
        {name: "album_desc", index: "album_desc", width:150, align: "center"},
        {name: "shop_id", index: "shop_id", width:150, align: "center"},
        {name: "shop_name", index: "shop_name", width:150, align: "center"},
        {name: "album_num", index: "album_num", width:150, align: "center"},
