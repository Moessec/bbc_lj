...
function initGrid( album_id, shop_id )
{
    ...
    var t = ["操作", "相册名称", "图片ID", "图片", "图片地址", "图片大小", "上传时间"], e = [{
        ...
        {name: "album_name", index: "album_name", width:150,  align: "center"},
        {name: "upload_id", index: "upload_id", width:150, align: "center"},
        {name: "image", index: "image", width:240, align: "center", formatter: imageOperFatter},
        {name: "upload_path", index: "image_address", width:200, align: "center"},
