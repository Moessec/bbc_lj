...
function initGrid()
{
    ...
    var t = ["操作", "mb_cat_image_id", "关联分类", "分类图片", "广告图片","广告地址"], e = [{
        name: "operate",
        width: 90,
        fixed: !0,
        align: "center",
        ...
        {name: "cat_adv_image", index: "cat_adv_image", align: "center",width: 100, formatter: imageFmatter},
        {name: "cat_adv_url", index: "cat_adv_url", align: "center", width: 200},
    ];
    $("#grid").jqGrid({
