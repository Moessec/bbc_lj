...
function initGrid()
{
    var t = ["操作", "名称", "类型", "展示方式", "宽度/字数", "高度", "广告数", "正在展示", "是否启用"], e = [{
        name: "operate",
        width: 60,
        fixed: !0,
        align: "center",
        ...
        {name: "widget_name", index: "widget_name", align: "center",width: 100},
        {name: "widget_type_name", index: "widget_type_name", width: 350},
        {name: "widget_display_type", index: "widget_display_type", width:150},
        {name: "widget_width", index: "widget_width", width:150},
        {name: "widget_height", index: "widget_height", width:150},
        {name: "widget_total", index: "widget_total", width:150},
        {name: "active_items_num", index: "active_items_num", width:150},
        {name: "widget_active_type", index: "widget_active_type", width:150},
    ];

    $("#grid").jqGrid({
        url: SITE_URL + "?ctl=Adv_WidgetBase&met=advWidgetBaseList&typ=json&isDelete=2",
        datatype: "json",
