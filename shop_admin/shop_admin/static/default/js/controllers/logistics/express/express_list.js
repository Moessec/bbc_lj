...
var THISPAGE = {
    ...
    loadGrid: function(){
        ...
        var colModel = [
            ...
            {name:'express_pinyin', label:'描述', width:250,align:'center'},
            {name:'express_status', label:'状态', width:80,align:'center'},
            {name:'express_commonorder', label:'常用', width:80, align:"center"},
