...
var THISPAGE = {
    ...
    loadGrid: function(){
        ...
        var colModel = [
            ...
            {name:'waybill_tpl_name', label:'模板名称', width:150, align:"center"},
            ...
            {name:'waybill_tpl_width', label:'宽度(mm)', width:80, align:"center"},
            {name:'waybill_tpl_height', label:'高度(mm)', width:80, align:"center"},
            {name:'waybill_tpl_enable', label:'是否启用', width:50, align:"center"},
            {name:'waybill_tpl_top', label:'上偏移', width:50, align:"center"},
            {name:'waybill_tpl_left', label:'左偏移', width:50, align:"center"},
