		...
		<div class="account_mes">
			...
			<table class="account_table">
				...
				<tr>
					...
					<td><input type="text" value="<?=$data['user_identity_card']?>" name="user_identity_card" id="identity_card" <?php if($data['user_identity_statu']==2){?> readonly <?php }?> onbeforepaste="clipboardData.setData('text',clipboardData.getData('text').replace(/[^\d.]/g,''))" onkeyup="value=value.replace(/[^\d.]/g,'')" ><div class="form-error"></div></td>
				</tr>
				  <tr>
                  <td class="check_name"><?=_('正面照预览：')?></td>
                  <td>
                    <div class="user-avatar"><span><img  id="image_img"  src="<?=image_thumb($data['user_identity_face_logo'],120,120) ?>" width="120" height="120" nc_type="avatar"></span></div>
				...
				<tr>
                  ...
                  <td>
                    <div class="user-avatar"><span><img  id="image_font_img"  src="<?=image_thumb($data['user_identity_font_logo'],120,120) ?>" width="120" height="120" nc_type="avatar"></span></div>
