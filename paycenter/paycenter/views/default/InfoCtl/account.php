		...
		<div class="account_mes">
			...
			<table class="account_table">
				...
				<tr>
					...
					<td class="account_ahref"><?php if($user_info['user_identity_statu'] == 0){?><a href="<?= Yf_Registry::get('url') ?>?ctl=Info&met=certification"><?=_('去实名认证')?></a><?php }elseif($user_info['user_identity_statu'] == 1){?><?=_('待审核')?><a href="<?= Yf_Registry::get('url') ?>?ctl=Info&met=certification"><?=_('重填实名认证')?></a><?php }elseif($user_info['user_identity_statu'] == 2){?><?=_('已实名认证成功')?><?php }else{?><?=_('认证失败')?><a href="<?= Yf_Registry::get('url') ?>?ctl=Info&met=certification"><?=_('重新去实名认证')?></a><?php }?></td>
				</tr>
				<tr>
					<td><?=_('证件类型')?></td>
