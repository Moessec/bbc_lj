...
//setcookie("", 1);
$from_app_id = request_int('from_app_id');
Yf_Registry::set('from_app_id', $from_app_id);
...
$wx_config = include_once 'wx.ini.php'; // 包含微信配置 cbin add 2016.3.23
