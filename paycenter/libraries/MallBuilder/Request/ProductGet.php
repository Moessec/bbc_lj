<?php
/**
 * TOP API: mall.products.get request
 * 
 * @author auto create
 * @since 1.0, 2015-09-04 16:44:15
 */
class MallBuilder_Request_ProductGet implements MallBuilder_Request_Interface
{
	/**
	 * 商品类目id.调用mall.itemcats.get获取;必须是叶子类目id,如果没有传product_id,那么cid和props必须要传.
	 **/
	private $cid;
	...
	public function check()
	{
		...
		Yf_Utils_Check::checkNotNull($this->fields,"fields");
	}
