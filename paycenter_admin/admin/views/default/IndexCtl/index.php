			...
			<div class="nav-wrap hidden cf"><!--订单-->
				...
				<div id="sub-nav">
					<ul class="cur cf" id="setting-base">
						...
						<li>
							<i class="iconfont icon-point"></i><a data-right="BU_QUERY" href="index.php?ctl=Config&met=site&typ=e&config_type%5B%5D=site" rel="pageTab" tabid="site-setting" tabtxt="站点设置">站点设置</a>
						</li>
					...
					<ul class="cf" id="setting-manage">
						<li>
							<i class="iconfont icon-point"></i><a data-right="BU_QUERY" href="index.php?ctl=Paycen_PayWithdraw&met=index" rel="pageTab" tabid="PayWithdraw_Withdraw"
																  tabtxt="提现服务器">提现服务器</a>
						</li>

						<li>
							<i class="iconfont icon-point"></i><a data-right="BU_QUERY" href="index.php?ctl=Paycen_PayCard&met=index" rel="pageTab" tabid="Paycen_PayCard" tabtxt="充值卡管理">充值卡管理</a>
						</li>
						<li>
