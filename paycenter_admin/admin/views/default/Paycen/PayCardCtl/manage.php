...
<!--            <div class="contacters">-->
<!--                <div class="grid-wrap cardimg">-->
<!--                    <img src="" id="card_img" height="168">-->
<!--                </div>-->
<!--                <div calss="btn_cardimg" style="margin:15 auto;text-align:center;margin-top:10px;margin-left:10px;">-->
<!--                    <input type="text" value="" readonly="readonly" class="ui-input" name="file" id="card_image" style="width:327px;">-->
<!--                    <input type="file" value="" class="ui-input" name="pic" id="pic" style="display: none;">-->
<!--                    <a href="javascript:uploadfile('充值卡图片','card',120,120,'card');" class="ui-btn ui-btn-sp mrb" id="upload" style="margin-left:5px;">上传</a>-->
<!--                </div>-->
<!--            </div>-->
    	 </form>
    </div>
...
<script src="./admin/static/default/js/controllers/paycard/paycard_manage.js"></script>
<?php
