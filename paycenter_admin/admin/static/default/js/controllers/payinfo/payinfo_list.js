...
var THISPAGE = {
    ...
    loadGrid: function(){
        ...
        var colModel = [
            ...
            {name:'user_identity_card', label:'身份证号码', width:110, align:"center"},
...
var handle = {
    operate: function (t, e)
    {
        if ("add" == t)
        {
            var i = "新增充值卡", a = {oper: t, callback: this.callback};
        }
        else
        {
        ...
        $.dialog({
            title: i,
            content: "url:./index.php?ctl=Paycen_PayInfo&met=getEditInfo&user_id="+e,
            data: a,
            width: 550,
            height: 100,
            max: !1,
