                  ...
                  <dd>
                    <div > <a href="javascript:void(0);"><span>
                     <input name="user_avatar" id="user_avatar" type="hidden" value="<?=$this->user['info']['user_avatar']?>" />
                      ...
                      <p id='user_upload' style="float:left;padding-left:10px;" class="upload_img"><?=_('图片上传')?><i class="iconfont icon-tupianshangchuan" style="font-size:21px;float:right;"></i></p>
                ...
                $.ajax({
                    ...
                    success:function(a){
                        if(a.status == 200)
                        {
                            ...
                            location.href= SITE_URL +"?ctl=User&met=getUserImg";
                        }
                        else
                        {
