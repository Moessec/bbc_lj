			...
			<form action="" id="register-form" method="post" novalidate="novalidate" onsubmit="return false;">
				...
				<div class="item-phone-wrap">
					<div class="form-item form-item-mobile" id="form-item-mobile">
						...
						<input type="text" id="re_user_mobile"  class="field re_user_mobile" placeholder="填写绑定手机号" maxlength="11" default="<i class=&quot;i-def&quot;></i>请输入绑定的手机号" onblur="checkMobile()" onfocus="showTip(this)">
						<i class="i-status"></i>
					</div>
					<div class="input-tip">
						<span></span>
