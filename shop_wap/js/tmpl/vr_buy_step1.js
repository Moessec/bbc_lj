...
$(function ()
{
    $.ajax({
        ...
        success: function (e)
        {
            ...
            $("#deposit").html(a);
            $("#totalPrice").html(t.goods_base.sumprice.toFixed(2));
            ...
            $("#totalPayPrice").html(payprice.toFixed(2));
        }
    });
    $("#ToBuyStep2").click(function ()
    {
        ...
        $.ajax({
            ...
            success: function (e)
            {
                ...
                if(e.data.uorder)
                {
                    location.href = PayCenterWapUrl + "?ctl=Info&met=pay&uorder=" + e.data.uorder;
                }
                /*if (e.datas.order_id)
                {
