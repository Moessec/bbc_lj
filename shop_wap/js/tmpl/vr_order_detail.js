...
$(function(){
    ...
    $.getJSON(ApiUrl + '/index.php?ctl=Buyer_Order&met=virtual&act=detail&typ=json',{key:key,order_id:order_id}, function(result) {
        ...
        $.getJSON(ApiUrl + '/index.php?ctl=Buyer_Order&met=getEntityList&typ=json', {shop_id:result.data.shop_id},function(result){
            if (result.status == 250) {
                return ;
            }
