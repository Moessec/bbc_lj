        ...
        $.ajax({
            type: "post", url: ApiUrl + "/index.php?ctl=Buyer_Bespeak&met=rentBespeak&typ=json", data: {k: key, u:getCookie('id')}, dataType: "json", success: function (e)
            {
                ...
                $.each(e.data.rent, function(key, value){
                       ...
                       tem+='<dd style="float: left;margin-left: 10px; width:70%;line-height: 0.9rem;color:#000;font-size:0.8rem">'+value.bespeak_title+'</dd>';
                       tem+='<dd style="float: left;margin-left: 10px; width:70%;line-height: 0.9rem;">发布时间：'+value.opentime+'</dd>'
                       tem+='<dd style="float: left;margin-left: 51px; width:70%;line-height: 0.9rem;">地点：'+value.bes_address+'</dd>';
                       tem+='<dd style="float: left;margin-left: 10px; width:70%;line-height: 0.9rem;">价格：'+value.rent_price+'</dd></div></dl></li></ul>';
