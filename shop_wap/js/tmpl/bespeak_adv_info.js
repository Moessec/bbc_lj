        ...
        $.ajax({
            type: "post", url: ApiUrl + "/index.php?ctl=Buyer_Bespeak&met=getbespeaklist&typ=json", data: {k:a,u:getCookie('id'), id: e}, dataType: "json", success: function (a)
            {
                ...
                $.each(a.data, function(key, value){
                       ...
                       tem+='<span style="color:#ADFF2F;display:block;margin-top:10px;font-size:0.9rem">预约说明</span><div class="com">';
                       ...
                       tem+='<div class="error-tips"></div><div class="form-btn"><a style="color: #fff" class="btn" href="bespeak_opera_adv.html?bespeak_id='+value.bespeak_id+'">申请预约</a></div></dl>';
                     var reg = new RegExp("\n","g");
