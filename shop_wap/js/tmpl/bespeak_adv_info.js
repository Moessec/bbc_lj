        ...
        $.ajax({
            type: "post", url: ApiUrl + "/index.php?ctl=Buyer_Bespeak&met=getbespeaklist&typ=json", data: {k:a,u:getCookie('id'), id: e}, dataType: "json", success: function (a)
            {
                ...
                $.each(a.data, function(key, value){
                       ...
                       tem+='<span id="com" style="width:90%;margin:auto"><textarea type="text" disabled="disabled" style="overflow:auto;background-attachment:fixed;background-repeat:no-repeat;border-style:solid;border-color:#FFFFFF">'+value.bespeak_com+'</textarea></span></div>';
