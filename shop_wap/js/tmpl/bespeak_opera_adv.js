$(function ()
{
    ...
    var a = getCookie("key");
    $.ajax({
        type: "post", url: ApiUrl + "/index.php?ctl=Buyer_Bespeak&met=addAdvBespeak&act=edit&typ=json", data: {k:a,u:getCookie('id'), id: e}, dataType: "json", success: function (a)
        {
            checkLogin(a.login);
            console.log(a);
    ...
    $(".btn").click(function ()
    {
        if ($.sValid())
        {
            ...
            $.ajax({
                type: "post",
                url: ApiUrl + "/index.php?ctl=Buyer_Bespeak&met=addAdvBespeak&typ=json",
